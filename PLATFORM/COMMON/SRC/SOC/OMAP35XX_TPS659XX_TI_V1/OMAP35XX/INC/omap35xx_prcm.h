...
#ifndef __OMAP35XX_PRCM_H
#define __OMAP35XX_PRCM_H
...
typedef volatile struct {
    ...
    unsigned int CM_CLKEN_PLL;              // offset 0x0000 
    unsigned int CM_CLKEN2_PLL;             // offset 0x0004
    unsigned int zzzReserved01[6];

    unsigned int CM_IDLEST_CKGEN;           // offset 0x0020 
    unsigned int CM_IDLEST2_CKGEN;          // offset 0x0024
    unsigned int zzzReserved02[2];

    unsigned int CM_AUTOIDLE_PLL;           // offset 0x0030 
    unsigned int CM_AUTOIDLE2_PLL;          // offset 0x0034
    unsigned int zzzReserved03[2];

    unsigned int CM_CLKSEL1_PLL;            // offset 0x0040 
    unsigned int CM_CLKSEL2_PLL;            // offset 0x0044 
    unsigned int CM_CLKSEL3_PLL;            // offset 0x0048 
    unsigned int CM_CLKSEL4_PLL;            // offset 0x004C 
    unsigned int CM_CLKSEL5_PLL;            // offset 0x0050 
    unsigned int zzzReserved04[7];

    unsigned int CM_CLKOUT_CTRL;            // offset 0x0070 
...
typedef volatile struct {
    ...
    unsigned int CM_FCLKEN_IVA2;             // offset 0x0000 
    unsigned int CM_CLKEN_PLL_IVA2;          // offset 0x0004 
    unsigned int zzzReserved01[6];

    unsigned int CM_IDLEST_IVA2;             // offset 0x0020 
    unsigned int CM_IDLEST_PLL_IVA2;         // offset 0x0024 
    unsigned int zzzReserved02[3];

    unsigned int CM_AUTOIDLE_PLL_IVA2;       // offset 0x0034 
    unsigned int zzzReserved03[2];

    unsigned int CM_CLKSEL1_PLL_IVA2;        // offset 0x0040 
    unsigned int CM_CLKSEL2_PLL_IVA2;        // offset 0x0044 
    unsigned int CM_CLKSTCTRL_IVA2;          // offset 0x0048 
    unsigned int CM_CLKSTST_IVA2;            // offset 0x004C 
...
typedef volatile struct {
    ...
    unsigned int CM_CLKEN_PLL_MPU;           // offset 0x0004 
    unsigned int zzzReserved02[6];

    unsigned int CM_IDLEST_MPU;              // offset 0x0020 
    unsigned int CM_IDLEST_PLL_MPU;          // offset 0x0024 
    unsigned int zzzReserved03[3];

    unsigned int CM_AUTOIDLE_PLL_MPU;        // offset 0x0034 
    unsigned int zzzReserved04[2];

    unsigned int CM_CLKSEL1_PLL_MPU;         // offset 0x0040 
    unsigned int CM_CLKSEL2_PLL_MPU;         // offset 0x0044 
    unsigned int CM_CLKSTCTRL_MPU;           // offset 0x0048 
    unsigned int CM_CLKSTST_MPU;             // offset 0x004C 
...
typedef volatile struct {
    ...
    unsigned int CM_FCLKEN_SGX;               // offset 0x0000 
    unsigned int zzzReserved01[3];

    unsigned int CM_ICLKEN_SGX;               // offset 0x0010 
    unsigned int zzzReserved02[3];

    unsigned int CM_IDLEST_SGX;               // offset 0x0020 
    unsigned int zzzReserved03[7];

    unsigned int CM_CLKSEL_SGX;               // offset 0x0040 
    unsigned int CM_SLEEPDEP_SGX;             // offset 0x0044 
    unsigned int CM_CLKSTCTRL_SGX;            // offset 0x0048 
    unsigned int CM_CLKSTST_SGX;              // offset 0x004C 
...
typedef volatile struct {
    ...
    unsigned int CM_FCLKEN_DSS;               // offset 0x0000 
    unsigned int zzzReserved01[3];

    unsigned int CM_ICLKEN_DSS;               // offset 0x0010 
    unsigned int zzzReserved02[3];

    unsigned int CM_IDLEST_DSS;               // offset 0x0020 
    unsigned int zzzReserved03[3];

    unsigned int CM_AUTOIDLE_DSS;             // offset 0x0030 
    unsigned int zzzReserved04[3];
    
    unsigned int CM_CLKSEL_DSS;               // offset 0x0040 
    unsigned int CM_SLEEPDEP_DSS;             // offset 0x0044 
    unsigned int CM_CLKSTCTRL_DSS;            // offset 0x0048 
    unsigned int CM_CLKSTST_DSS;              // offset 0x004C 
...
typedef volatile struct {
    ...
    unsigned int CM_FCLKEN_CAM;               // offset 0x0000     
    unsigned int zzzReserved01[3];

    unsigned int CM_ICLKEN_CAM;               // offset 0x0010 
    unsigned int zzzReserved02[3];

    unsigned int CM_IDLEST_CAM;               // offset 0x0020 
    unsigned int zzzReserved03[3];

    unsigned int CM_AUTOIDLE_CAM;             // offset 0x0030 
    unsigned int zzzReserved04[3];

    unsigned int CM_CLKSEL_CAM;               // offset 0x0040 
    unsigned int CM_SLEEPDEP_CAM;             // offset 0x0044 
    unsigned int CM_CLKSTCTRL_CAM;            // offset 0x0048 
    unsigned int CM_CLKSTST_CAM;              // offset 0x004C 
...
typedef volatile struct {
    ...
    unsigned int CM_FCLKEN_PER;               // offset 0x0000 
    unsigned int zzzReserved01[3];

    unsigned int CM_ICLKEN_PER;               // offset 0x0010 
    unsigned int zzzReserved02[3];

    unsigned int CM_IDLEST_PER;               // offset 0x0020 
    unsigned int zzzReserved03[3];

    unsigned int CM_AUTOIDLE_PER;             // offset 0x0030 
    unsigned int zzzReserved04[3];

    unsigned int CM_CLKSEL_PER;               // offset 0x0040 
    unsigned int CM_SLEEPDEP_PER;             // offset 0x0044 
    unsigned int CM_CLKSTCTRL_PER;            // offset 0x0048 
    unsigned int CM_CLKSTST_PER;              // offset 0x004C 
...
typedef volatile struct {
    ...
    unsigned int CM_FCLKEN_WKUP;              // offset 0x0000     
    unsigned int zzzReserved01[3];

    unsigned int CM_ICLKEN_WKUP;              // offset 0x0010 
    unsigned int zzzReserved02[3];

    unsigned int CM_IDLEST_WKUP;              // offset 0x0020 
    unsigned int zzzReserved03[3];

    unsigned int CM_AUTOIDLE_WKUP;            // offset 0x0030 
    unsigned int zzzReserved04[3];

    unsigned int CM_CLKSEL_WKUP;              // offset 0x0040 
...
typedef volatile struct {
    ...
    unsigned int zzzReserved01[16];

    unsigned int CM_CLKSEL1_EMU;              // offset 0x0040 
    unsigned int zzzReserved02[1];

    unsigned int CM_CLKSTCTRL_EMU;            // offset 0x0048 
    unsigned int CM_CLKSTST_EMU;              // offset 0x004C 
    unsigned int CM_CLKSEL2_EMU;              // offset 0x0050 
    unsigned int CM_CLKSEL3_EMU;              // offset 0x0054 
...
typedef volatile struct {
    ...
    unsigned int zzzReserved01[8];

    unsigned int CM_IDLEST_NEON;               // offset 0x0020 
    unsigned int zzzReserved02[9];
    unsigned int CM_CLKSTCTRL_NEON;            // offset 0x0048 
...
typedef volatile struct {
    ...
    unsigned int CM_FCLKEN_USBHOST;            // offset 0x0000     
    unsigned int zzzReserved01[3];

    unsigned int CM_ICLKEN_USBHOST;            // offset 0x0010 
    unsigned int zzzReserved02[3];

    unsigned int CM_IDLEST_USBHOST;            // offset 0x0020 
    unsigned int zzzReserved03[3];

    unsigned int CM_AUTOIDLE_USBHOST;          // offset 0x0030 
    unsigned int zzzReserved04[4];

    unsigned int CM_SLEEPDEP_USBHOST;          // offset 0x0044 
    unsigned int CM_CLKSTCTRL_USBHOST;         // offset 0x0048 
    unsigned int CM_CLKSTST_USBHOST;           // offset 0x004C 
...
typedef volatile struct {
    ...
    unsigned int CM_REVISION;                  // offset 0x0000
    unsigned int zzzReserved01[3];

    unsigned int CM_SYSCONFIG;                 // offset 0x0010
...
typedef volatile struct {
    ...
    unsigned int zzzReserved01[39];

    unsigned int CM_POLCTRL;                   // offset 0x009C 
...
typedef volatile struct {
    ...
    unsigned int PRM_REVISION;                 // offset 0x0004 
    unsigned int zzzReserved02[3];

    unsigned int PRM_SYSCONFIG;                // offset 0x0014 
    unsigned int PRM_IRQSTATUS_MPU;            // offset 0x0018 
    unsigned int PRM_IRQENABLE_MPU;            // offset 0x001C 
...
typedef volatile struct {
    ...
    unsigned int PRM_VC_SMPS_SA;               // offset 0x0020 
    unsigned int PRM_VC_SMPS_VOL_RA;           // offset 0x0024 
    unsigned int PRM_VC_SMPS_CMD_RA;           // offset 0x0028 
    unsigned int PRM_VC_CMD_VAL_0;             // offset 0x002C 
    unsigned int PRM_VC_CMD_VAL_1;             // offset 0x0030 
    unsigned int PRM_VC_CH_CONF;               // offset 0x0034 
    unsigned int PRM_VC_I2C_CFG;               // offset 0x0038 
    unsigned int PRM_VC_BYPASS_VAL;            // offset 0x003C 
    unsigned int zzzReserved02[4];             // offset 0x0040

    unsigned int PRM_RSTCTRL;                  // offset 0x0050 
    unsigned int PRM_RSTTIME;                  // offset 0x0054 
    unsigned int PRM_RSTST;                    // offset 0x0058
    unsigned int zzzReserved03[1];             // offset 0x005C
    unsigned int PRM_VOLTCTRL;                 // offset 0x0060 
    unsigned int PRM_SRAM_PCHARGE;             // offset 0x0064 
    unsigned int zzzReserved04[2];             // offset 0x0068

    unsigned int PRM_CLKSRC_CTRL;              // offset 0x0070 
    unsigned int zzzReserved05[3];             // offset 0x0074

    unsigned int PRM_OBS;                      // offset 0x0080
    unsigned int zzzReserved06[3];             // offset 0x0084

    unsigned int PRM_VOLTSETUP1;               // offset 0x0090 
    unsigned int PRM_VOLTOFFSET;               // offset 0x0094 
    unsigned int PRM_CLKSETUP;                 // offset 0x0098 
    unsigned int PRM_POLCTRL;                  // offset 0x009C 
    unsigned int PRM_VOLTSETUP2;               // offset 0x00A0 
    unsigned int zzzReserved07[3];

    unsigned int PRM_VP1_CONFIG;               // offset 0x00B0 
    unsigned int PRM_VP1_VSTEPMIN;             // offset 0x00B4
    unsigned int PRM_VP1_VSTEPMAX;             // offset 0x00B8
    unsigned int PRM_VP1_VLIMITTO;             // offset 0x00BC
    unsigned int PRM_VP1_VOLTAGE;              // offset 0x00C0
    unsigned int PRM_VP1_STATUS;               // offset 0x00C4
    unsigned int zzzReserved08[2];             // offset 0x00C8
    
    unsigned int PRM_VP2_CONFIG;               // offset 0x00D0
    unsigned int PRM_VP2_VSTEPMIN;             // offset 0x00D4
    unsigned int PRM_VP2_VSTEPMAX;             // offset 0x00D8
    unsigned int PRM_VP2_VLIMITTO;             // offset 0x00DC
    unsigned int PRM_VP2_VOLTAGE;              // offset 0x00E0
    unsigned int PRM_VP2_STATUS;               // offset 0x00E4

    unsigned int zzzReserved09[2];             // offset 0x00E8

    // DM3730 only
    unsigned int PRM_LDO_ABB_SETUP;            // offset 0x00F0
    unsigned int PRM_LDO_ABB_CTRL;             // offset 0x00F4
...
typedef volatile struct {
    ...
    unsigned int zzzReserved01[20];

    unsigned int RM_RSTCTRL_CORE;              // offset 0x0050 
    unsigned int zzzReserved02[1];

    unsigned int RM_RSTST_CORE;                // offset 0x0058 
    unsigned int zzzReserved03[17];

    unsigned int PM_WKEN1_CORE;                // offset 0x00A0 
    unsigned int PM_MPUGRPSEL1_CORE;           // offset 0x00A4 
    unsigned int PM_IVA2GRPSEL1_CORE;          // offset 0x00A8 
    unsigned int zzzReserved04[1];

    unsigned int PM_WKST1_CORE;                // offset 0x00B0 
    unsigned int zzzReserved05[1];             // offset 0x00B4
    unsigned int PM_WKST3_CORE;                // offset 0x00B8
    unsigned int zzzReserved06[9];             // offset 0x00BC

    unsigned int PM_PWSTCTRL_CORE;             // offset 0x00E0 
    unsigned int PM_PWSTST_CORE;               // offset 0x00E4 
    unsigned int PM_PREPWSTST_CORE;            // offset 0x00E8 

    unsigned int zzzReserved07[1];             // offset 0x00EC
    unsigned int PM_WKEN3_CORE;                // offset 0x00F0
    unsigned int PM_IVA2GRPSEL3_CORE;          // offset 0x00F4
    unsigned int PM_MPUGRPSEL3_CORE;           // offset 0x00F8
...
typedef volatile struct {
    ...
    unsigned int RM_RSTCTRL_IVA2;              // offset 0x0050 
    unsigned int zzzReserved02[1];

    unsigned int RM_RSTST_IVA2;                // offset 0x0058 
    unsigned int zzzReserved03[27];

    unsigned int PM_WKDEP_IVA2;                // offset 0x00C8 
    unsigned int zzzReserved04[5];

    unsigned int PM_PWSTCTRL_IVA2;             // offset 0x00E0 
    unsigned int PM_PWSTST_IVA2;               // offset 0x00E4 
    unsigned int PM_PREPWSTST_IVA2;            // offset 0x00E8 
    unsigned int zzzReserved05[3];

    unsigned int PRM_IRQSTATUS_IVA2;           // offset 0x00F8 
    unsigned int PRM_IRQENABLE_IVA2;           // offset 0x00FC 
...
typedef volatile struct {
    ...
    unsigned int zzzReserved01[22];

    unsigned int RM_RSTST_PER;                 // offset 0x0058 
    unsigned int zzzReserved02[17];

    unsigned int PM_WKEN_PER;                  // offset 0x00A0 
    unsigned int PM_MPUGRPSEL_PER;             // offset 0x00A4 
    unsigned int PM_IVA2GRPSEL_PER;            // offset 0x00A8 
    unsigned int zzzReserved03[1];

    unsigned int PM_WKST_PER;                  // offset 0x00B0 
    unsigned int zzzReserved04[5];

    unsigned int PM_WKDEP_PER;                 // offset 0x00C8 
    unsigned int zzzReserved05[5];

    unsigned int PM_PWSTCTRL_PER;              // offset 0x00E0 
    unsigned int PM_PWSTST_PER;                // offset 0x00E4 
    unsigned int PM_PREPWSTST_PER;             // offset 0x00E8 
...
typedef volatile struct {
    ...
    unsigned int RM_RSTST_DSS;                 // offset 0x0058 
    unsigned int zzzReserved02[17];

    unsigned int PM_WKEN_DSS;                  // offset 0x00A0 
    unsigned int zzzReserved03[9];

    unsigned int PM_WKDEP_DSS;                 // offset 0x00C8 
    unsigned int zzzReserved04[5];

    unsigned int PM_PWSTCTRL_DSS;              // offset 0x00E0 
    unsigned int PM_PWSTST_DSS;                // offset 0x00E4 
    unsigned int PM_PREPWSTST_DSS;             // offset 0x00E8 
...
typedef volatile struct {
    ...
    unsigned int RM_RSTST_MPU;                 // offset 0x0058 
    unsigned int zzzReserved02[27];

    unsigned int PM_WKDEP_MPU;                 // offset 0x00C8 
    unsigned int zzzReserved03[2];

    unsigned int PM_EVGENCTRL_MPU;             // offset 0x00D4 
    unsigned int PM_EVGENONTIM_MPU;            // offset 0x00D8 
    unsigned int PM_EVGENOFFTIM_MPU;           // offset 0x00DC 
    unsigned int PM_PWSTCTRL_MPU;              // offset 0x00E0 
    unsigned int PM_PWSTST_MPU;                // offset 0x00E4 
    unsigned int PM_PREPWSTST_MPU;             // offset 0x00E8 
...
typedef volatile struct {
    ...
    unsigned int RM_RSTST_CAM;                 // offset 0x0058 
    unsigned int zzzReserved02[27];

    unsigned int PM_WKDEP_CAM;                 // offset 0x00C8 
    unsigned int zzzReserved03[5];

    unsigned int PM_PWSTCTRL_CAM;              // offset 0x00E0 
    unsigned int PM_PWSTST_CAM;                // offset 0x00E4 
    unsigned int PM_PREPWSTST_CAM;             // offset 0x00E8 
...
typedef volatile struct {
    ...
    unsigned int RM_RSTST_SGX;                 // offset 0x0058 
    unsigned int zzzReserved02[27];

    unsigned int PM_WKDEP_SGX;                 // offset 0x00C8 
    unsigned int zzzReserved03[5];

    unsigned int PM_PWSTCTRL_SGX;              // offset 0x00E0 
    unsigned int PM_PWSTST_SGX;                // offset 0x00E4 
    unsigned int PM_PREPWSTST_SGX;             // offset 0x00E8 
...
typedef volatile struct {
    ...
    unsigned int RM_RSTST_NEON;                // offset 0x0058 
    unsigned int zzzReserved02[27];

    unsigned int PM_WKDEP_NEON;                // offset 0x00C8 
    unsigned int zzzReserved03[5];

    unsigned int PM_PWSTCTRL_NEON;             // offset 0x00E0 
    unsigned int PM_PWSTST_NEON;               // offset 0x00E4 
    unsigned int PM_PREPWSTST_NEON;            // offset 0x00E8 
...
typedef volatile struct {
    ...
    unsigned int RM_RSTST_USBHOST;             // offset 0x0058 
    unsigned int zzzReserved02[17];

    unsigned int PM_WKEN_USBHOST;              // offset 0x00A0 
    unsigned int PM_MPUGRPSEL_USBHOST;         // offset 0x00A4 
    unsigned int PM_IVA2GRPSEL_USBHOST;        // offset 0x00A8 
    unsigned int zzzReserved03[1];

    unsigned int PM_WKST_USBHOST;              // offset 0x00B0 
    unsigned int zzzReserved04[5];

    unsigned int PM_WKDEP_USBHOST;             // offset 0x00C8 
    unsigned int zzzReserved05[5];

    unsigned int PM_PWSTCTRL_USBHOST;          // offset 0x00E0 
    unsigned int PM_PWSTST_USBHOST;            // offset 0x00E4 
    unsigned int PM_PREPWSTST_USBHOST;         // offset 0x00E8 
...
typedef volatile struct {
    ...
    unsigned int zzzReserved01[40];

    unsigned int PM_WKEN_WKUP;                 // offset 0x00A0 
    unsigned int PM_MPUGRPSEL_WKUP;            // offset 0x00A4 
    unsigned int PM_IVA2GRPSEL_WKUP;           // offset 0x00A8 
    unsigned int zzzReserved02[1];

    unsigned int PM_WKST_WKUP;                 // offset 0x00B0 
...
typedef volatile struct {
    ...
    unsigned int RM_RSTST_EMU;                 // offset 0x0058 
    unsigned int zzzReserved02[34];

    unsigned int PM_PWSTST_EMU;                // offset 0x00E4 
...
typedef volatile struct {
    ...
    unsigned int PRM_CLKSEL;                   // offset 0x0040 
    unsigned int zzzReserved02[11];

    unsigned int PRM_CLKOUT_CTRL;              // offset 0x0070 
...
typedef volatile struct {
    ...
    union {
        unsigned int CM_FCLKEN_xxx;            // offset 0x0000
        unsigned int CM_FCLKEN1_xxx;           // offset 0x0000
    };
    
    unsigned int CM_CLKEN_PLL_xxx;             // offset 0x0004
    unsigned int CM_FCLKEN3_xxx;               // offset 0x0008
    unsigned int zzzReserved01[1];             // offset 0x000C
 
    union {
        unsigned int CM_ICLKEN_xxx;            // offset 0x0010
        unsigned int CM_ICLKEN1_xxx;           // offset 0x0010
    };
    
    unsigned int CM_ICLKEN2_xxx;               // offset 0x0014
    unsigned int CM_ICLKEN3_xxx;               // offset 0x0018
    unsigned int zzzReserved02[1];             // offset 0x001C

    union {
        unsigned int CM_IDLEST_xxx;            // offset 0x0020 
        unsigned int CM_IDLEST1_xxx;           // offset 0x0020 
    };

    union {
        unsigned int CM_IDLEST_PLL_xxx;        // offset 0x0024
        unsigned int CM_IDLEST2_xxx;           // offset 0x0024 
    };
    
    unsigned int CM_IDLEST3_xxx;               // offset 0x0028
    unsigned int zzzReserved03[1];             // offset 0x002C

    union {
        unsigned int CM_AUTOIDLE_xxx;          // offset 0x0030 
        unsigned int CM_AUTOIDLE1_xxx;         // offset 0x0030 
    };

    unsigned int CM_AUTOIDLE2_xxx;             // offset 0x0034
    unsigned int CM_AUTOIDLE3_xxx;             // offset 0x0038
    unsigned int zzzReserved04[1];             // offset 0x003C

    unsigned int CM_CLKSEL_xxx;                // offset 0x0040
    union {
        unsigned int CM_SLEEPDEP_xxx;          // offset 0x0044 
        unsigned int CM_CLKSEL1_xxx;
    };
    unsigned int CM_CLKSTCTRL_xxx;             // offset 0x0048 
    unsigned int CM_CLKSTST_xxx;               // offset 0x004C 
    unsigned int CM_CLKSEL2_xxx;               // offset 0x0050 
    unsigned int CM_CLKSEL3_xxx;               // offset 0x0054
...
typedef volatile struct {
    ...
    unsigned int RM_RSTCTRL_xxx;               // offset 0x0050 
    unsigned int zzzReserved02[1];

    unsigned int RM_RSTST_xxx;                 // offset 0x0058 
    unsigned int zzzReserved03[17];            // offset 0x005c

    union {
        unsigned int PM_WKEN_xxx;              // offset 0x00A0 
        unsigned int PM_WKEN1_xxx;             // offset 0x00A0 
    };
    
    unsigned int PM_MPUGRPSEL1_xxx;            // offset 0x00A4 
    unsigned int PM_IVA2GRPSEL1_xxx;           // offset 0x00A8 
    unsigned int zzzReserved04[1];

    unsigned int PM_WKST_xxx;                  // offset 0x00B0 
    unsigned int zzzReserved05[1];             // offset 0x00B4
    unsigned int PM_WKST3_xxx;                 // offset 0x00B8
    unsigned int zzzReserved06[3];             // offset 0X00BC

    unsigned int PM_WKDEP_xxx;                 // offset 0x00C8 
    unsigned int zzzReserved07[2];             // offset 0x00cc

    unsigned int PM_EVGENCTRL_xx;              // offset 0x00D4 
    unsigned int PM_EVGENONTIM_xxx;            // offset 0x00D8 
    unsigned int PM_EVGENOFFTIM_xxx;           // offset 0x00DC
 
    unsigned int PM_PWSTCTRL_xxx;              // offset 0x00E0 
    unsigned int PM_PWSTST_xxx;                // offset 0x00E4 
    unsigned int PM_PREPWSTST_xxx;             // offset 0x00E8 

    unsigned int zzzReserved08[1];             // offset 0x00EC
    unsigned int PM_WKEN3_xxx;                 // offset 0x00F0
    unsigned int PM_IVA2GRPSEL3_xxx;           // offset 0x00F4
    unsigned int PM_MPUGRPSEL3_xxx;            // offset 0x00F8
...
//-----------------------------------------------------------------------------
typedef struct {
    unsigned int BOOT_CONFIG_ADDR;              // offset 0x0000
    unsigned int PUBLIC_RESTORE_ADDR;           // offset 0x0004
    unsigned int SECURE_SRAM_RESTORE_ADDR;      // offset 0x0008
    unsigned int SDRC_MODULE_SEMAPHORE;         // offset 0x000C
    unsigned int PRCM_BLOCK_OFFSET;             // offset 0x0010
    unsigned int SDRC_BLOCK_OFFSET;             // offset 0x0014
    unsigned int zzzReserved01;                 // offset 0x0018
    unsigned int OEM_CPU_INFO_DATA_PA;          // offset 0x001C    // priv
    unsigned int OEM_CPU_INFO_DATA_VA;          // offset 0x0020    // priv
} OMAP_CONTEXT_RESTORE_REGS;

//-----------------------------------------------------------------------------
typedef struct {
    unsigned int PRM_CLKSRC_CTRL;               // offset 0x0000
    unsigned int PRM_CLKSEL;                    // offset 0x0004
    unsigned int CM_CLKSEL_CORE;                // offset 0x0008
    unsigned int CM_CLKSEL_WKUP;                // offset 0x000c
    unsigned int CM_CLKEN_PLL;                  // offset 0x0010
    unsigned int CM_AUTOIDLE_PLL;               // offset 0x0014
    unsigned int CM_CLKSEL1_PLL;                // offset 0x0018
    unsigned int CM_CLKSEL2_PLL;                // offset 0x001c
    unsigned int CM_CLKSEL3_PLL;                // offset 0x0020
    unsigned int CM_CLKEN_PLL_MPU;              // offset 0x0024
    unsigned int CM_AUTOIDLE_PLL_MPU;           // offset 0x0028
    unsigned int CM_CLKSEL1_PLL_MPU;            // offset 0x002c
    unsigned int CM_CLKSEL2_PLL_MPU;            // offset 0x0030
    unsigned int zzzReserved01;                 // offset 0x0034
    unsigned int CM_CLKSTCTRL_MPU;              // offset 0x0038    // priv
    unsigned int CM_CLKSTCTRL_CORE;             // offset 0x003C    // priv
...
typedef struct {
    ...
    unsigned int   DLLA_CTRL;                   // offset 0x0008
    unsigned int   DLLB_CTRL;                   // offset 0x000C
    unsigned int   POWER;                       // offset 0x0010
    unsigned int   zzzReserved01;               // offset 0x0014
    unsigned int   MCFG_0;                      // offset 0x0018
    ...
    unsigned int   ACTIM_CTRLA_0;               // offset 0x0024
    unsigned int   ACTIM_CTRLB_0;               // offset 0x0028
    unsigned int   RFR_CTRL_0;                  // offset 0x002C
    unsigned int   zzzReserved02;               // offset 0x0030
    unsigned int   MCFG_1;                      // offset 0x0034
    ...
    unsigned int   ACTIM_CTRLA_1;               // offset 0x0040
    unsigned int   ACTIM_CTRLB_1;               // offset 0x0044
    unsigned int   RFR_CTRL_1;                  // offset 0x0048
    unsigned short DCDL_1_CTRL;                 // offset 0x004C
    unsigned short DCDL_2_CTRL;                 // offset 0x004E
    unsigned int   zzzReserved03;               // offset 0x0050
    unsigned int   zzzReserved04;               // offset 0x0054
...
#define CM_IDLEST_ST_SSI_IDLE               (1 << 8)
#define CM_IDLEST_ST_MAILBOXES              (1 << 7)
#define CM_IDLEST_ST_OMAPCTRL               (1 << 6)
#define CM_IDLEST_ST_HSOTGUSB_IDLE          (1 << 5)
#define CM_IDLEST_ST_HSOTGUSB_STDBY         (1 << 4)
