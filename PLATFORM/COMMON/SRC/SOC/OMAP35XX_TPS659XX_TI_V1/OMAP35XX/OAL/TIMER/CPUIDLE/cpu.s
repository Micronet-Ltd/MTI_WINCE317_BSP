...
;IF  INTR_TEST_POINT_A = 1
;        stmdb      sp!, {r5-r7} 
        
;        ldr        r5, [r4, #TEST_GPIO_REG_OFFSET]
;        mov        r7, #0x40000000
;        str        r7, [r5, #SETDATAOUT_OA]
...
;        orr     r1, r2, #0x80                   ; set interrupt disable bit
...
;        mrs     r2, cpsr                        ; (r0) = current status
;        bic     r1, r2, #0x80                   ; clear interrupt disable bit
;        msr     cpsr, r1                        ; update status register
