...
{
    /* 3530 */
    { CPU_OMAP_3530, HAWKEYE_OMAP35XX, CPU_FAMILY_OMAP35XX, 0x0C00},
    /* 3525 */
    { CPU_OMAP_3525, HAWKEYE_OMAP35XX, CPU_FAMILY_OMAP35XX, 0x4C00},
    /* 3515 */
    { CPU_OMAP_3515, HAWKEYE_OMAP35XX, CPU_FAMILY_OMAP35XX, 0x1C00},
    /* 3503 */
    { CPU_OMAP_3503, HAWKEYE_OMAP35XX, CPU_FAMILY_OMAP35XX, 0x5C00},

    /* 3730 */
    { CPU_DM_3730, HAWKEYE_DM37XX, CPU_FAMILY_DM37XX, 0x0C00},
    /* 3725 */
    { CPU_DM_3725, HAWKEYE_DM37XX, CPU_FAMILY_DM37XX, 0x4C00},
    /* 3715 */
    { CPU_DM_3715, HAWKEYE_DM37XX, CPU_FAMILY_DM37XX, 0x1C00},
    /* 3703 */
    { CPU_DM_3703, HAWKEYE_DM37XX, CPU_FAMILY_DM37XX, 0x5C00},
    { 0, 0, 0, 0},
...
Get_CPUVersion(void)
{
    ...
    {
        CpuRevision |= (CPU_AM_3517 << CHIP_ID_SHIFT);
    }
    else
    {
