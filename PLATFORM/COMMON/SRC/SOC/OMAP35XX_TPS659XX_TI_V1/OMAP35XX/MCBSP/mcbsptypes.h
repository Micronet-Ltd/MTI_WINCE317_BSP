...
#define MCBSP1_BASE_ADDRESS         0x48074000
#define MCBSP2_BASE_ADDRESS         0x49022000
#define MCBSP3_BASE_ADDRESS         0x49024000
#define MCBSP4_BASE_ADDRESS         0x49026000
#define MCBSP5_BASE_ADDRESS         0x48096000

#define DEVCONF0_ADDRESS            0x48002274
#define DEVCONF1_ADDRESS            0x480022D8

#define MCBSP_CLKS_EXTERNAL 1
#define DEVCONF0_MCBSP1_CLKS        (0x1 << 2)
#if defined (MCBSP_CLKS_EXTERNAL)
#define DEVCONF0_MCBSP2_CLKS        (0x1 << 6)
#else
#define DEVCONF0_MCBSP2_CLKS        (0x3 << 3)
#endif
#define DEVCONF1_MCBSP3_CLKS        (0x1 << 0)
#define DEVCONF1_MCBSP4_CLKS        (0x1 << 2)
#define DEVCONF1_MCBSP5_CLKS        (0x1 << 4)
...
EXTERN_C void GetMcbspType(McBSPDevice_t *pDevice,
                           DWORD dwAddress);
EXTERN_C void ConfigureDevConfForClks(McBSPDevice_t *pDevice,
                                      BOOL bEnable);
