...
//        DDOVERLAYCAPS_ALPHASRC |             
	...
	// original values 
    //lpddhi->ddCaps.dwMinOverlayStretch = 100;    // Shrink to 10% of original size
    //lpddhi->ddCaps.dwMaxOverlayStretch = 16000;  // Expand to 16x original size

    // the ability of the OMAP display controller to shrink a video overlay is limited
