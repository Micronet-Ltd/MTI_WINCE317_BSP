...
// TWL_DIGMIXING
#define DIGMIXING_VTX_MIXING(control)                   ((control) << 2)
#define DIGMIXING_ARX2_MIXING(control)                  ((control) << 4)
#define DIGMIXING_ARX1_MIXING(control)                  ((control) << 6)
...
// TWL_BT_IF
#define BT_IF_BT_DIN_EN                                 (1 << 6)
#define BT_IF_BT_DOUT_EN                                (1 << 5)
#define BT_IF_BT_SWAP                                   (1 << 4)
#define BT_IF_BT_TRI_EN                                 (1 << 2)
#define BT_IF_BT_EN                                     (1 << 0)
...
//TWL_BTPGA
#define BTTXPGA_GAIN(gain)                              ( ((gain) << 4) & 0xF0 )
#define BTRXPGA_GAIN(gain)                              ( ((gain) << 0) & 0x0F )

// TWL_VRX2ARXPGA
#define VRX2ARXPGA_GAIN(gain)                           ((gain) << 0)
...
#define MISC_SET_SMOOTH_ANAVOL_EN                       (1 << 1)
...
#define GET_ANAMIC_MICAMPL_GAIN(gain)                   ((gain)& 0x7)
#define GET_ANAMIC_MICAMPR_GAIN(gain)                   ( ( (gain)>>3 ) & 0x7 )
