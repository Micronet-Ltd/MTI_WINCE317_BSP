...
Alg. nº O : AEC-NS  on the DL and UL paths
Alg. nº 1 : EQ Left channel on the DL path
Alg. nº 2 : EQ Right channel on the DL path
The ACDN1 contains 2 algorithms:
Alg. nº O : Compressor on the DL path
Alg. nº 1 : Equalizer on the UL path
*/
