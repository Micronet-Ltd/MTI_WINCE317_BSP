...
#define NAND_CMD_READ_PP			0xEC        //  Reead parameters page
#define NAND_CMD_SET_FEATURE		0xEF        //  Set feature
...
#define NAND_STATUS_NWP				0x80        //  write-protected
#define NAND_STATUS_READY           0x40        //  Ready
#define NAND_STATUS_CORRECTED       0x08        //  Data Corrected
