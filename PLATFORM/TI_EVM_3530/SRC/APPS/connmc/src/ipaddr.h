...
#define	GET_CONTROL_HANDLE(hWnd)	((CONTROL *)(GetWindowLong((hWnd), 0)))
#define SAVE_CONTROL_HANDLE(hWnd,x)	(SetWindowLong((hWnd), 0, (LONG)x))
...
/* use to register and unregister the IP class */
