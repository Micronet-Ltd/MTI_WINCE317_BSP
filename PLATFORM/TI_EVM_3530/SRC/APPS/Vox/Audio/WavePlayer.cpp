...
{
	m_hStop			= CreateEvent( NULL, TRUE,	FALSE,	NULL/*_T("Play Stop All")*/ );
	m_hStopWaiting	= CreateEvent( NULL, TRUE,	FALSE,	NULL/*_T("Play Stop"))*/ );
	m_hStart1		= CreateEvent( NULL, FALSE,	FALSE,	NULL /*_T("Play Start1"))*/ );
	m_hStart2		= CreateEvent( NULL, FALSE,	FALSE,	NULL /*_T("Play Start2"))*/ );
	m_hDoneEvent	= CreateEvent( NULL, FALSE,	FALSE,	NULL /*_T("Play Done"))*/ );
}
