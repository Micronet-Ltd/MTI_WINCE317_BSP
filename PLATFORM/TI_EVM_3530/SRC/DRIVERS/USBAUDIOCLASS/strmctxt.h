...
public:
    ...
    DWORD MapGain(DWORD dwStreamGain, DWORD Channel);
...
protected:
    ...
    DWORD       m_dwChannels;          // number of physical channels on device
};
...
protected:
    PBYTE Render2FromMono(PBYTE pBuffer, PBYTE pBufferEnd, PBYTE pBufferLast);
    PBYTE Render2FromStereo(PBYTE pBuffer, PBYTE pBufferEnd, PBYTE pBufferLast);
};
...
{
protected:
    PBYTE Render2ToMono(PBYTE pBuffer, PBYTE pBufferEnd, PBYTE pBufferLast, TRANSFER_STATUS *pTransferStatus);
    PBYTE Render2ToStereo(PBYTE pBuffer, PBYTE pBufferEnd, PBYTE pBufferLast, TRANSFER_STATUS *pTransferStatus);
