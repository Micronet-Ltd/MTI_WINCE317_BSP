...
public:
	...
	*******************************************************************************/
	void convertToPrecMode(const EPRECMODE ePrecMode, CPVRTextureHeader& sHeader);
	...
	*******************************************************************************/
	...
	void SwapChannels(unsigned int uChannelA, unsigned int uChannelB)
	{
		Pixel<tType>* pixelData = (Pixel<tType>*)m_pData;
		unsigned int numPixels = m_stDataSize/(4*sizeof(tType));
		for(unsigned int i=0 ; i < numPixels ;++i)
		{
			PVRTswap<tType>((*pixelData)[uChannelA],(*pixelData)[uChannelB]);
			++pixelData;
		}
	}
