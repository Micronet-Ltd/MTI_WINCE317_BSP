...
RESOURCES = \
	$(CONTENTDIR)/mask1.cpp \
	$(CONTENTDIR)/mask2.cpp
...
mask1.pvr: $(MEDIAPATH)/mask1.bmp
	$(PVRTEXTOOL) -nt -fOVG_A_8 -i$(MEDIAPATH)/mask1.bmp -o$@

mask2.pvr: $(MEDIAPATH)/mask2.bmp
	$(PVRTEXTOOL) -nt -fOVG_A_8 -i$(MEDIAPATH)/mask2.bmp -o$@

############################################################################
# Create content files
############################################################################

$(CONTENTDIR)/mask1.cpp: mask1.pvr
	$(FILEWRAP)  -o $@ mask1.pvr

$(CONTENTDIR)/mask2.cpp: mask2.pvr
	$(FILEWRAP)  -o $@ mask2.pvr
