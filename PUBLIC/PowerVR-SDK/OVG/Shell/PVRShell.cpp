...
/*! Get FPS prints by default */
#ifndef PVRSHELL_FPS_DEFAULT_OUTPUT
#define PVRSHELL_FPS_DEFAULT_OUTPUT false
#endif

/*!  Override the Swap default interval for demo purposes. */
#ifndef PVRSHELL_SWAP_INTERVAL
#define PVRSHELL_SWAP_INTERVAL 1
#endif
...
PVRShell::PVRShell()
{
	...
	m_pShellData->nSwapInterval = PVRSHELL_SWAP_INTERVAL;
	...
	m_pShellData->bOutputFPS = PVRSHELL_FPS_DEFAULT_OUTPUT;
#endif
}
