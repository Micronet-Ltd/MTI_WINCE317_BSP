 ...
 *                                                                    *
 * Copyright © 2005-2007 The Khronos Group                            *
 *                                                                    *
 **********************************************************************/
...
VG_API_CALL	void	vgClearGlyph(VGFont font,
											 VGuint glyphIndex);
...
VG_API_CALL void vgRenderToMask(VGPath path, VGbitfield paintModes,
...
VG_API_CALL void vgCopyMask(VGMaskLayer maskLayer,
							VGint sx, VGint sy, VGint dx, VGint dy,
							VGint width, VGint height);
