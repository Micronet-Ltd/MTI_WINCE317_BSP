...
LineRound.pvr: $(MEDIAPATH)/White.bmp $(MEDIAPATH)/LineRound.bmp
	$(PVRTEXTOOL) -m -nt -fOGL88 -i$(MEDIAPATH)/White.bmp -a$(MEDIAPATH)/LineRound.bmp -o$@

############################################################################
# Create content files
############################################################################

$(CONTENTDIR)/LineRound.cpp: LineRound.pvr
