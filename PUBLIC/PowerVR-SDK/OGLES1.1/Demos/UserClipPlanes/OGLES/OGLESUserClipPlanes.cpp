...
const char c_szSceneFile[]	= "Mesh_fixed.pod";
#else
const char c_szSceneFile[]	= "Mesh_float.pod";
#endif
...
public:
	OGLESUserClipPlanes() : m_i32Frame(0L),
							...
							m_puiIndexVbo(0)
	{
		m_vLightPos = PVRTVec4(f2vt(-1.0f), f2vt(1.0f), f2vt(1.0f), f2vt(0.0f));
	}
...
bool OGLESUserClipPlanes::InitView()
{
	...
	mPerspective = PVRTMat4::PerspectiveFovRH(f2vt(20.0f*(PVRT_PIf/180.0f)), f2vt((float) PVRShellGet(prefWidth)/(float) PVRShellGet(prefHeight)), f2vt(10.0f), f2vt(1200.0f), PVRTMat4::OGL, bRotate);
	...
	fAmbient  = PVRTVec4(f2vt(0.4f), f2vt(0.4f), f2vt(0.4f), f2vt(1.0f));
	fDiffuse  = PVRTVec4(f2vt(1.0f), f2vt(1.0f), f2vt(1.0f), f2vt(1.0f));
	fSpecular = PVRTVec4(f2vt(1.0f), f2vt(1.0f), f2vt(1.0f), f2vt(1.0f));
	...
	myglLightv(GL_LIGHT0, GL_POSITION, m_vLightPos.ptr());

	glEnable(GL_LIGHT0);

	PVRTVec4 ambient_light = PVRTVec4(f2vt(0.8f), f2vt(0.8f), f2vt(0.8f), f2vt(1.0f));
	myglLightModelv(GL_LIGHT_MODEL_AMBIENT, ambient_light.ptr());

	// Setup all materials
	fAmbient  = PVRTVec4(f2vt(0.1f), f2vt(0.1f), f2vt(0.1f), f2vt(1.0f));
	fDiffuse  = PVRTVec4(f2vt(0.5f), f2vt(0.5f), f2vt(0.5f), f2vt(1.0f));
	fSpecular = PVRTVec4(f2vt(1.0f), f2vt(1.0f), f2vt(1.0f), f2vt(1.0f));

	myglMaterialv(GL_FRONT_AND_BACK, GL_AMBIENT,   fAmbient.ptr());
	myglMaterialv(GL_FRONT_AND_BACK, GL_DIFFUSE,   fDiffuse.ptr());
	myglMaterialv(GL_FRONT_AND_BACK, GL_SPECULAR,  fSpecular.ptr());
...
bool OGLESUserClipPlanes::RenderScene()
{
	...
	myglRotate(f2vt((float)m_i32Frame/5.0f),f2vt(0),f2vt(1),f2vt(0));
...
void OGLESUserClipPlanes::SetupUserClipPlanes()
{
	...
	myglClipPlane(GL_CLIP_PLANE0, equation0);
	...
	myglClipPlane( GL_CLIP_PLANE1, equation1);
	...
	myglClipPlane( GL_CLIP_PLANE2, equation2);
	...
	myglClipPlane( GL_CLIP_PLANE3, equation3);
	...
	myglClipPlane(GL_CLIP_PLANE4, equation4);
	...
	myglClipPlane(GL_CLIP_PLANE5, equation5);
