...
{
	static float	VerticesRight[] = {
			(1.0f-LOGO_SHIFT-LOGO_SIZE)	, (-1.0f+(LOGO_SIZE*(50.0f/64.0f))+LOGO_SHIFT)	, (0.5f),
			(1.0f-LOGO_SHIFT-LOGO_SIZE)	, (-1.0f+LOGO_SHIFT)							, (0.5f),
			(1.0f-LOGO_SHIFT)			, (-1.0f+(LOGO_SIZE*(50.0f/64.0f))+LOGO_SHIFT)	, (0.5f),
	 		(1.0f-LOGO_SHIFT)	 		, (-1.0f+LOGO_SHIFT)							, (0.5f)
		};
	...
	float *pVertices = ( (float*)&VerticesRight );
	...
	{
		PVRTMATRIX matRot;
		PVRTMatrixRotationZ(matRot, -90.0f*PVRT_PI/180.0f);
		PVRTMatrixMultiply(matModelView, matModelView, matRot);
	}
