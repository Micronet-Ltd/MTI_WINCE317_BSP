...
char*		g_ShaderList[] = { "envmap", "directional_lighting", "anisotropic_lighting", "fasttnl", "lattice", "point_lighting", "phong_lighting", "reflections", "simple", "spot_lighting", "toon", "vertex_sine", "wood"};
char*		g_SurfacesList[] = {"Torus", "Moebius", "KleinBottle", "BoySurface", "DiniSurface"};
char*		g_TextureList[] = {"base", "reflection", "anisotropicmap", "cubemap"};
...
bool OGLES2Shaders::InitView()
{
	...
	m_mView = *(PVRTMat4 *)g_afIdentityMatrix;
