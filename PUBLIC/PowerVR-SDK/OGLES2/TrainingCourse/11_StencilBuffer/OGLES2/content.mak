...
Lattice.pvr: $(MEDIAPATH)/cylinder.bmp $(MEDIAPATH)/cylindera.bmp
	$(PVRTEXTOOL) -nt -fOGL8888 -i$(MEDIAPATH)/cylinder.bmp -a$(MEDIAPATH)/cylindera.bmp -o$@

Stone.pvr: $(MEDIAPATH)/stone.bmp
	$(PVRTEXTOOL) -m -nt -fOGL8888 -i$(MEDIAPATH)/stone.bmp -o$@

Tile.pvr: $(MEDIAPATH)/tile.bmp
	$(PVRTEXTOOL) -m -nt -fOGL8888 -i$(MEDIAPATH)/tile.bmp -o$@
