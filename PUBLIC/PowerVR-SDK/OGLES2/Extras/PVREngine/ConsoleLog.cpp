...
Main features are the ability to output a file of the log's contents, whether this is written
to constantly or not. The primary function is log() which takes formatted input and logs to
the console.
******************************************************************************/
