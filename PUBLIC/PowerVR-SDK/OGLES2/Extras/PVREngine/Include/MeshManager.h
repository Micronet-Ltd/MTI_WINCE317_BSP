...
@Brief  	 	A class for holing information about meshes.
...
@Description   	A class for holding information about meshes as they are loaded
so that duplicate meshes are not kept in memory and so the things
can be disposed of easily at the end of execution.
******************************************************************************/
