...
void PVRESettings::setBackColour(const float fRed, const float fGreen, const float fBlue, const float fAlpha)
{
	glClearColor(fRed, fGreen, fBlue, fAlpha);
}
	/******************************************************************************/

void PVRESettings::setBackColour(const float fRed, const float fGreen, const float fBlue)
{
