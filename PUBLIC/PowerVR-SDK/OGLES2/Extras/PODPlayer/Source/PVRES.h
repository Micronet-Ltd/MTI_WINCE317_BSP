...
@Brief		   A class for holding the information from a .pvres script file in
a more useful form for the PVREngine.
...
@Description   A class for holding the information from a .pvres script file in
a more useful form for the PVREngine.
******************************************************************************/
