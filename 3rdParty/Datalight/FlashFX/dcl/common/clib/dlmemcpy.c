...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: dlmemcpy.c $
    Revision 1.5  2009/06/25 20:07:08Z  garyp
    Updated to use new asserts.
    Revision 1.4  2009/04/09 14:13:20Z  davidh
    Function headers updated for AutoDoc.
    Revision 1.3  2007/12/18 19:21:31Z  brandont
    ...
    Modified to re-enable profiling.
    ...
    parameter.
    Revision 1.1  2005/07/26 00:16:28Z  pauli
    Initial revision
---------------------------------------------------------------------------*/
    ...
    size_t          nLen)
{
    ...
    const char *    pbSrc = (const char *)pSrc;

    DclProfilerEnter("DclMemCpy", DCLPROF_TOPLEVEL, nLen);
