...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: dlatoi.c $
    Revision 1.5  2009/06/24 21:56:37Z  garyp
    Updated to use new asserts.
    Revision 1.4  2009/04/09 14:13:14Z  davidh
    Function headers updated for AutoDoc.
    Revision 1.3  2007/12/18 03:21:01Z  brandont
    Updated function headers.
    Revision 1.2  2007/11/03 23:31:09Z  Garyp
    Added the standard module header.
    Revision 1.1  2005/10/02 03:57:02Z  Pauli
    Initial revision
    Revision 1.3  2005/08/04 04:46:08Z  Garyp
    ...
    implementation.
    Revision 1.2  2005/08/03 19:17:48Z  pauli
    Replaced DCL_FuncName with DclFuncName.
    Revision 1.1  2005/04/10 04:21:00Z  pauli
    Initial revision
---------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------
    ...
    Note that this function does NOT ignore leading white space.

    Parameters:
        pach - Pointer to a constant array of characters.
...
int DclAtoI(
    const char *pach)
{
    DclAssertReadPtr(pach, 0);

    return (int)DclAtoL(pach);
}
