...
REM $Log: addlibs.bat $
REM Revision 1.2  2008/07/23 18:27:07Z  keithg
REM Clarified comments with professional customer facing terms.
REM Revision 1.1  2005/12/01 01:59:28Z  Pauli
REM Initial revision
REM Revision 1.2  2005/12/01 01:59:27Z  Pauli
...
REM Revision 1.2  2005/05/12 19:04:13Z  garyp
REM Fixed to work properly again.  Broke when the original DIAB ToolSet wase split
REM into separate 5.x and 6.x ToolSets.
REM Revision 1.1  2005/05/03 23:26:34Z  GaryP
REM Initial revision
REM -------------------------------------------------------------------------
...
copy %1 altmp\.
cd altmp
for %%a in (*.%B_LIBEXT%) do %B_LIB% -x %%a
