...
REM Revision 1.4  2007/12/01 01:53:45Z  brandont
REM Added an argument to the library command to indicate to use 32-bit
REM record sizes.
REM Revision 1.3  2006/12/07 23:08:11Z  Garyp
...
REM Revision 1.2  2006/11/08 00:51:28Z  Garyp
...
REM Revision 1.2  2005/03/18 22:05:44Z  GaryP
...
REM -----------------------------------------------
:DisplayInfo
echo   "devtools"   - Works with the Datalight SDTK
goto Fini
