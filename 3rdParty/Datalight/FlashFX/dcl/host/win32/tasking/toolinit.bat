...
REM Revision 1.3  2006/12/07 23:08:07Z  Garyp
...
REM Revision 1.2  2006/11/08 00:50:17Z  Garyp
...
REM Revision 1.2  2005/03/18 22:05:42Z  GaryP
REM Documentation update.
REM Revision 1.1  2005/01/11 19:20:26Z  GaryP
REM Initial revision
REM -------------------------------------------------------------------------
...
REM If the "auto" CPU was specified, default to "tricore"
if not "%P_CPUFAMILY%" == "auto" goto NotAuto
set P_CPUFAMILY=tricore
set P_CPUTYPE=tricore
:NotAuto

if not "%P_CPUFAMILY%" == "tricore" goto BadCPU
...
if "%B_INPATH%" == "" set B_REDIR=%P_TOOLROOT%\%B_TOOLBIN%\%B_REDIR%
...
REM -----------------------------------------------
:DisplayInfo
echo   "tasking"    - Works with the Altium TASKING tools
goto Fini
