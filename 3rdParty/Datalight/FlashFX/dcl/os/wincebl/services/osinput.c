...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: osinput.c $
    Revision 1.6  2009/12/02 22:10:08Z  garyp
    Removed a hard-coded prototype.
    Revision 1.5  2009/02/07 23:54:46Z  garyp
    Merge from the v4.0 branch.  Renamed DclOsGetChar() to DclOsInputChar(),
    and extended the interface to accommodate more sophisticated input systems.
    Revision 1.4  2008/03/19 20:27:59Z  Garyp
    Implemented DclOsGetChar().
