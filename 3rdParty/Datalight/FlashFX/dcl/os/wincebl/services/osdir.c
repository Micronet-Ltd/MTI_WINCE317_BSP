...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: osdir.c $
    Revision 1.8  2009/04/10 20:52:21Z  garyp
    Documentation updated -- no functional changes.
    Revision 1.7  2008/05/07 20:41:10Z  garyp
    Updated DclOsFsDirGetWorking() to not assert (again). 
    Revision 1.6  2008/04/10 22:15:44Z  brandont
    Updated to use the new file system services.
    Revision 1.5  2008/04/05 03:56:07Z  brandont
    Updated to use the DclOsFs services prefix.
    Revision 1.4  2008/04/03 23:30:21Z  brandont
    Updated all defines and structures used by the DCL file system
    services to use the DCLFS prefix.
    Revision 1.3  2008/03/19 20:28:40Z  Garyp
    Updated DclOsFsDirGetWorking() to not assert.  Documentation updates.
