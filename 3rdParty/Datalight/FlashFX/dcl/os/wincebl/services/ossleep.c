...
/*---------------------------------------------------------------------------
                              Revision History
    $Log: ossleep.c $
    Revision 1.3  2009/04/10 20:52:23Z  garyp
    Documentation updated -- no functional changes.
    Revision 1.2  2007/11/03 23:31:38Z  Garyp
    Added the standard module header.
    Revision 1.1  2005/10/02 03:58:14Z  Pauli
    Initial revision
---------------------------------------------------------------------------*/
...
{
    /*  Pre-OS, we might not have the ability to sleep available;
        OEM can modify this routine if they have their own routines that
        can be used. By Default, we do nothing.
    */
    return;
}
