...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: osatomic.c $
    Revision 1.3  2010/01/23 21:26:57Z  garyp
    Added DclOsAtomic32ExchangeAdd().  Cleaned up the documentation
    and some variable names.
    Revision 1.2  2009/06/28 02:46:20Z  garyp
    Merged from the v3.0 branch.
    Revision 1.1  2008/12/18 18:24:40Z  garyp
    Initial revision
---------------------------------------------------------------------------*/
    ...
    D_UINT32        ulExchange)
{
    ...
    return DclAtomic32CompareExchange(pulAtomic, ulCompare, ulExchange);
}
    ...
    D_UINT32        ulExchange)
{
    ...
    return DclAtomic32Exchange(pulAtomic, ulExchange);
}
    ...
    D_UINT32        ulAdd)
{
    ...
    return DclAtomic32ExchangeAdd(pulAtomic, ulAdd);
}
    ...
    D_ATOMIC32     *pulAtomic)
{
    ...
    return DclAtomic32Decrement(pulAtomic);
}
    ...
    D_ATOMIC32     *pulAtomic)
{
    ...
    return DclAtomic32Increment(pulAtomic);
}
    ...
    void           *pExchange)
{
    ...
    return DclAtomicPtrCompareExchange(pDestination, pCompare, pExchange);
}
    ...
    void           *pExchange)
{
    ...
    return DclAtomicPtrExchange(pDestination, pExchange);
}
