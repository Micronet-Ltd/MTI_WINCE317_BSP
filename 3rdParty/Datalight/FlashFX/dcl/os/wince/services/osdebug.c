...
/*---------------------------------------------------------------------------
    ...
    Revision 1.2  2007/04/04 20:49:07Z  Garyp
    Added a missing include.
    Revision 1.1  2007/04/01 22:01:48Z  Garyp
    Initial revision
---------------------------------------------------------------------------*/
    ...
    D_UINT32        ulDebugCmd)
{
    switch(ulDebugCmd)
    {
        ...
        case DCLDBGCMD_BREAK:
            /*  Would be nice to leave this in all the time, however, if running
                on the release version of CE, this function will apparently
                cause the driver to fault and terminate with no message.
            */
            DebugBreak();
            return DCLSTAT_SUCCESS;
      #else
