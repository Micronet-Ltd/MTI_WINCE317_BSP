...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: osinput.c $
    Revision 1.5  2009/02/07 23:54:46Z  garyp
    ...
    systems.
    Revision 1.4  2007/12/17 06:01:44Z  Garyp
    Updated so console input is disabled for WinMobile.
    Revision 1.3  2007/11/03 23:31:36Z  Garyp
    Added the standard module header.
    Revision 1.2  2006/12/12 20:57:35Z  Garyp
    Documentation update.
    Revision 1.1  2005/10/02 03:57:40Z  Pauli
    Initial revision
---------------------------------------------------------------------------*/
    ...
    unsigned    nFlags)
{
    ...
    /*  Version 5.02 is WinMobile 6, which does not support console
        input.  The only place where it can be used is for the
        Target Control window shell extensions, and those DLLs have
        their own private implementation of DclOsGetChar().
    */
