...
/*---------------------------------------------------------------------------
    ...
    This header defines the Windows CE BootLoader function interface to the
    Datalight Common Libraries.
...
/*---------------------------------------------------------------------------
    ...
    due to refactoring.
    Revision 1.3  2009/10/09 01:27:16Z  garyp
    ...
    Revision 1.1  2008/03/27 22:35:26Z  Garyp
    Initial revision
---------------------------------------------------------------------------*/

#ifndef DCL_WINCEBL_H_INCLUDED
#define DCL_WINCEBL_H_INCLUDED
