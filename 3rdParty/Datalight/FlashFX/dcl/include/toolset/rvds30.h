...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: rvds30.h $
    Revision 1.4  2009/11/25 22:37:46Z  keithg
    Corrected Bug 2894, removed obsolete DCLPACK definition.
    Revision 1.3  2007/11/03 23:31:20Z  Garyp
    Added the standard module header.
    Revision 1.2  2007/01/28 00:45:32Z  Garyp
    Updated to define the ToolSet name.
    Revision 1.1  2006/10/07 00:50:12Z  Garyp
    Initial revision
---------------------------------------------------------------------------*/

#ifndef RVDS30_H_INCLUDED
#define RVDS30_H_INCLUDED


/*-------------------------------------------------------------------
    Define the ToolSet name.
-------------------------------------------------------------------*/
#define DCL_TOOLSETNAME             "RVDS30"
