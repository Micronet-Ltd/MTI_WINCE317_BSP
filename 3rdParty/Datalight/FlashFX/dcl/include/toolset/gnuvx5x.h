...
#ifndef GNUVX5X_H_INCLUDED
#define GNUVX5X_H_INCLUDED
...
-------------------------------------------------------------------*/
#define DCL_TOOLSETNAME             "GNUVX5X"
