...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: gnuvx6x.h $
    Revision 1.17  2010/06/09 16:30:07Z  jimmb
    Updated VxWorks build files to support VxWorks 6.9
    Revision 1.16  2010/06/02 16:28:05Z  garyp
    Backed out the previous revision.
    Revision 1.15  2010/06/02 15:12:04Z  garyp
    Added the DCL_VA_ARG_DATATYPE_MINIMUM_IS_INT setting.
    Revision 1.14  2009/11/25 22:33:22Z  keithg
    Corrected Bug 2894, removed obsolete DCLPACK definition.
    Revision 1.13  2009/08/20 21:52:46Z  jimmb
    Updated VxWorks build files to support VxWorks 6.8
    Revision 1.12  2008/08/25 20:04:37Z  jimmb
    Updated for VxWorks 6.7
    Revision 1.11  2007/11/07 17:25:25Z  pauli
    Made #error messages strings to prevent macro expansion.
    Revision 1.10  2007/11/03 23:31:20Z  Garyp
    Added the standard module header.
    Revision 1.9  2007/08/29 21:41:29Z  jimmb
    updated the BAT files to support the new VxWorks 6.6 and the
    GNU compiler 4.1.2
    Revision 1.8  2007/01/28 00:45:33Z  Garyp
    Updated to define the ToolSet name.
    Revision 1.7  2007/01/18 18:35:23Z  peterb
    (Per gp) updated to work with VxWorks 6.5.
    Revision 1.6  2006/08/28 02:47:48Z  Garyp
    Added VxWorks 6.4 support.
    Revision 1.5  2006/05/26 20:14:35Z  tonyq
    Updated with VxWorks 6.3 support
    Revision 1.4  2006/05/05 03:19:06Z  Garyp
    Modified to define D_(U)INTPTR in fixed 32-bit terms since the (u)intptr_t
    types appear to not be available.
    Revision 1.3  2006/04/26 22:23:28Z  billr
    Support for pointers wider than 32 bits.
    Revision 1.2  2006/01/20 23:24:27Z  brandont
    Added defines for DCL_OS_VERSION.
    Revision 1.1  2005/12/02 16:45:38Z  Pauli
    Initial revision
    Revision 1.3  2005/12/02 16:45:37Z  Pauli
    Merge with 2.0 product line, build 173.
    Revision 1.2  2005/10/21 02:59:02Z  garyp
    Documentation cleanup.
    Revision 1.1  2005/06/20 22:32:02Z  Garyp
    Initial revision
    Revision 1.5  2005/09/22 00:49:49Z  brandont
    ...
    Revision 1.3  2005/06/20 21:06:25Z  Pauli
...
#ifndef GNUVX6X_H_INCLUDED
#define GNUVX6X_H_INCLUDED
...
-------------------------------------------------------------------*/
#define DCL_TOOLSETNAME             "GNUVX6X"
