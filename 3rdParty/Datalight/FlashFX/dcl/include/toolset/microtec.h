...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: microtec.h $
    Revision 1.4  2009/11/25 22:37:44Z  keithg
    Corrected Bug 2894, removed obsolete DCLPACK definition.
    Revision 1.3  2007/11/03 23:31:20Z  Garyp
    Added the standard module header.
    Revision 1.2  2007/01/28 00:45:33Z  Garyp
    Updated to define the ToolSet name.
    Revision 1.1  2006/12/08 01:28:08Z  Garyp
    Initial revision
---------------------------------------------------------------------------*/

#ifndef MICROTEC_H_INCLUDED
#define MICROTEC_H_INCLUDED


/*-------------------------------------------------------------------
    Define the ToolSet name.
-------------------------------------------------------------------*/
#define DCL_TOOLSETNAME             "MICROTEC"


/*-------------------------------------------------------------------
    Define whether 64-bit types are natively supported or not.  It
    appears that the Microtec tools do not support 64-bit types.
-------------------------------------------------------------------*/
