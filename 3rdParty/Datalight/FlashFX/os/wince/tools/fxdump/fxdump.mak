...
#                               Revision History
#       $Log: fxdump.mak $
#       Revision 1.7  2012/02/17 16:25:13Z  johnb
#       Added dlwinutil and fxoeapi to PRODLIBS for mswcepb toolset
#       Revision 1.6  2009/02/08 16:21:56Z  garyp
...
#       Revision 1.5  2008/11/10 21:47:00Z  johnb
#       Remove B_INCLUDES default value
#       Revision 1.4  2008/11/07 15:23:53Z  johnb
...
ALLTARGETS =    $(B_RELDIR)\fxdump.exe
...
COMMONDEPS = 	fxdump.mak $(B_RELDIR)\flashfx.$(B_LIBEXT)
...
OSTOOLSDIR :
	@echo Processing os\$(P_OS)\Tools\FXDump...

$(B_RELDIR)\fxdump.exe : $(COMMONDEPS) fxdump.$(B_OBJEXT)
	echo /out:$(B_RELDIR)\fxdump.exe fxdump.$(B_OBJEXT)	 >fxdump.lnk
	echo $(B_CESDKDIR)\coredll.lib				>>fxdump.lnk
	echo $(B_CESDKDIR)\corelibc.lib				>>fxdump.lnk
	echo $(B_RELDIR)\flashfx.$(B_LIBEXT)			>>fxdump.lnk
	$(B_LINK) /nodefaultlib $(B_LFLAGS)			 @fxdump.lnk
...
fxdump.$(B_OBJEXT)   : $(OSTOOLSHEADERS)   fxdump.c
...
mswcepb : OSTOOLSDIR TOOLSETINIT $(PRODLIBS)
	...
	@echo TARGETNAME=fxdump						 >>sources
