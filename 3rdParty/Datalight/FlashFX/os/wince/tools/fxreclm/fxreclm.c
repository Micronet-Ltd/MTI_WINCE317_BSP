...
/*---------------------------------------------------------------------------
    ...
    level header.
    Revision 1.6  2008/03/26 01:23:04Z  Garyp
    Updated to compile when allocator support is disabled.
    Revision 1.5  2007/11/28 22:45:04Z  Garyp
    Updated to use the new DCL functions to support output redirection.
    Revision 1.4  2007/11/03 23:50:14Z  Garyp
    Updated to use the standard module header.
    Revision 1.3  2007/08/05 22:25:06Z  garyp
    Updated to return standard errorlevel values as defined in dlerrlev.h
    (where possible).
    Revision 1.2  2006/02/13 09:54:50Z  Garyp
    Updated to new Devices and Disk configuration model.
    Revision 1.1  2005/10/03 15:14:46Z  Pauli
    Initial revision
    Revision 1.5  2005/06/12 04:40:28Z  PaulI
    Set DCL output function to redirect output to the extapi function.
    Revision 1.4  2004/12/30 23:14:00Z  GaryP
    Updated to use indents of 4, hard tabs of 8 (if used), and a standard
    comment style.
    Revision 1.3  2003/12/05 07:06:20Z  garys
    Merge from FlashFXMT
    Revision 1.2.1.3  2003/12/05 07:06:20  garyp
    Modified to use the new oemmount() function.
    Revision 1.2.1.2  2003/11/14 23:15:58Z  garyp
    Modified to work with FFX-MT and use the new external API.
    Revision 1.2  2003/05/08 18:46:38Z  garyp
