...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: fhecc.c $
    Revision 1.11  2009/12/11 03:08:44Z  garyp
    Updated to use an NTMHOOKHANDLE rather than a PNANDCTL.
    Revision 1.10  2009/10/20 14:09:25Z  garyp
    Removed some incorrect asserts.
    Revision 1.9  2009/10/06 21:21:47Z  garyp
    Removed an incorrect "const" modifier.
    Revision 1.8  2009/10/06 18:38:04Z  garyp
    ...
    structure.
    Revision 1.7  2009/04/08 20:27:22Z  davidh
    Function headers updated for AutoDoc.
    Revision 1.6  2009/02/18 21:41:31Z  glenns
    Added code to prevent compiler warnings about unused formal parameters.
    Revision 1.5  2007/11/03 23:50:11Z  Garyp
    Updated to use the standard module header.
    Revision 1.4  2007/10/14 21:12:30Z  Garyp
    Modified to use a renamed function.
    Revision 1.3  2006/02/17 22:16:07Z  Garyp
    Modified the ECC hook functions to take an hDev parameter.
    Revision 1.2  2006/02/10 02:15:30Z  Garyp
    Updated to use device/disk handles rather than the EXTMEDIAINFO structure.
    Revision 1.1  2005/11/07 17:46:08Z  Pauli
    Initial revision
    Revision 1.2  2005/11/07 17:46:07Z  Garyp
    Updated to new function prototypes and eliminated global data.
    Revision 1.1  2005/10/06 06:48:26Z  Garyp
    Initial revision
    Revision 1.2  2004/12/31 00:15:27Z  GaryP
    Updated to use indents of 4, hard tabs of 8 (if used), and a standard
    comment style.
    Revision 1.1  2004/02/23 05:53:24Z  garyp
    Initial revision
---------------------------------------------------------------------------*/
#include <flashfx.h>
