...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: fhpageio.c $
    Revision 1.9  2009/04/08 20:39:24Z  davidh
    Function headers updated for AutoDoc.
    Revision 1.8  2009/04/02 20:35:53Z  glenns
    - Fix Bugzilla #2468: Removed usage of ill-defined FXSTATUS
      ...
      status values.
    Revision 1.7  2009/02/17 08:00:31Z  keithg
    Added explicit void to unused function parameters.
    Revision 1.6  2009/01/17 00:04:32Z  glenns
    - Fixed up literal FFXIOSTATUS initialization in several places.
    Revision 1.5  2008/10/23 15:55:34Z  keithg
    ...
    Revision 1.3  2007/02/14 00:19:03Z  timothyj
    ...
    corresponding casts.
    Revision 1.2  2006/03/12 01:28:57Z  Garyp
    Updated to the current ntpageio NTM model.
    Revision 1.1  2005/12/08 17:32:42Z  Garyp
    Initial revision
---------------------------------------------------------------------------*/
#include <flashfx.h>
#include <fxiosys.h>
    ...
    D_BUFFER       *pBuffer)
{
    ...
    FFXTRACEPRINTF((MAKETRACEFLAGS(FFXTRACE_NTMHOOK, 1, 0),
        "FfxHookNTPageReadHidden() Start=%lX Count=%U Scale=%U pBuffer=%P\n",
