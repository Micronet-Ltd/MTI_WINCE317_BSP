...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: fhecc.c $
    Revision 1.10  2009/12/11 03:03:48Z  garyp
    Updated to use an NTMHOOKHANDLE rather than a PNANDCTL.
    Revision 1.9  2009/10/20 14:02:57Z  garyp
    Removed some incorrect asserts.
    Revision 1.8  2009/10/06 21:21:53Z  garyp
    Removed an incorrect "const" modifier.
    Revision 1.7  2009/10/06 18:34:54Z  garyp
    ...
    structure.
    Revision 1.6  2009/04/08 19:36:55Z  davidh
    Function headers updated for AutoDoc.
    Revision 1.5  2009/02/18 21:40:50Z  glenns
    Added code to prevent compiler warnings about unused formal parameters.
    Revision 1.4  2008/06/25 23:41:32Z  billr
    Update copyright.
    Revision 1.3  2008/06/25 23:08:47Z  billr
    Update so it builds.
    Revision 1.2  2007/11/03 23:49:54Z  Garyp
    Updated to use the standard module header.
    Revision 1.1  2006/02/17 22:16:10Z  brandont
    Initial revision
---------------------------------------------------------------------------*/
#include <flashfx.h>
