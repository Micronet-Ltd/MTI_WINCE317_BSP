...
/*---------------------------------------------------------------------------
    ...
    This module contains the RTOS Hooks Layer default implementations
    for:
...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: fhdevice.c $
    Revision 1.5  2009/07/17 20:42:56Z  garyp
    Merged from the v4.0 branch.  Eliminated use of an obsolete header.
    Revision 1.4  2009/04/08 19:38:17Z  davidh
    Function headers updated for AutoDoc.
    Revision 1.3  2008/03/23 04:11:06Z  Garyp
    ...
    Revision 1.1  2006/02/15 00:44:24Z  brandont
    Initial revision
    Revision 1.5  2006/02/15 00:44:23Z  Pauli
    Updated to return on error.
    Revision 1.4  2006/02/15 00:07:50Z  Garyp
    Updated to properly stuff the pDev->uDeviceNum field on successful
    completion.
    Revision 1.3  2006/02/14 04:22:05Z  Pauli
    Updated header dependencies.
    Revision 1.2  2006/02/14 03:25:43Z  Pauli
    Updated to assign the device num of the FFXDEVINFO structure.
    Revision 1.1  2006/02/10 01:30:06Z  Garyp
    Initial revision
---------------------------------------------------------------------------*/
