...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: fhcad.c $
    Revision 1.7  2009/10/14 01:23:25Z  keithg
    Removed now obsolete fxio.h include file.
    Revision 1.6  2009/07/19 04:41:39Z  garyp
    Merged from the v4.0 branch.  Documentation updates only.
    Revision 1.5  2009/02/24 02:53:08Z  glenns
    Added clarifying comment regarding use of status register rather than the
    READY/~BUSY line for determining device status.
    Revision 1.4  2008/01/25 07:43:04Z  keithg
    Comment style updates to support autodoc.
    Revision 1.3  2007/11/03 23:50:17Z  Garyp
    Updated to use the standard module header.
    Revision 1.2  2006/07/09 02:39:03Z  Garyp
    Fixed to build cleanly (hopefully).
    Revision 1.1  2006/07/07 17:53:24Z  Garyp
    Initial revision
---------------------------------------------------------------------------*/
#include <flashfx.h>
#include <nandconf.h>
