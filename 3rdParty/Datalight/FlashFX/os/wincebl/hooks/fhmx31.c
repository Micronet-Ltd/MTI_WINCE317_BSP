...
/*---------------------------------------------------------------------------
    ...
    Revision 1.1  2007/05/07 17:51:50Z  timothyj
    Initial revision
---------------------------------------------------------------------------*/
...
*/
static void *pCCMBase = (void *)CCM_REGS_PHYS_BASE;
...
/*-------------------------------------------------------------------
    ...
    Deallocate (if necessary) and deinitialize the MX31 control structure.
