...
/*---------------------------------------------------------------------------
    ...
    This module contains the RTOS Hooks Layer default implementations for:
...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: fhdisk.c $
    Revision 1.11  2009/07/17 19:16:42Z  garyp
    Merged from the v4.0 branch.  Eliminated use of an obsolete header.
    Revision 1.10  2009/04/08 15:00:55Z  davidh
    Function headers updated for AutoDoc.
    Revision 1.9  2008/03/21 17:09:45Z  Garyp
    ...
    Revision 1.8  2008/01/13 07:29:16Z  keithg
    Function header updates to support autodoc.
    Revision 1.7  2007/11/03 23:50:01Z  Garyp
    Updated to use the standard module header.
    Revision 1.6  2006/10/13 01:42:29Z  Garyp
    Updated to initialize the disk format settings.
    Revision 1.5  2006/10/04 01:04:32Z  Garyp
    Updated to use DclMemAllocZero().
    Revision 1.4  2006/02/15 02:59:12Z  Garyp
    Split out the compaction settings.
    Revision 1.3  2006/02/15 00:07:49Z  Garyp
    Updated to properly stuff the pDisk->uDiskNum field on successful
    completion.
    Revision 1.2  2006/02/14 03:42:23Z  Pauli
