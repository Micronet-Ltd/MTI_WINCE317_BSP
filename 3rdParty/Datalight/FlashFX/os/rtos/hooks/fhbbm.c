...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: fhbbm.c $
    Revision 1.12  2009/08/02 19:35:14Z  garyp
    ...
    Revision 1.11  2009/04/08 14:55:44Z  davidh
    Function headers updated for AutoDoc.
    Revision 1.10  2009/03/18 18:06:36Z  glenns
    Fix Bugzilla #2370: Remove commentary about obsolete block status values.
    Revision 1.9  2008/01/13 07:29:13Z  keithg
    Function header updates to support autodoc.
    Revision 1.8  2007/11/03 23:50:01Z  Garyp
    Updated to use the standard module header.
    Revision 1.7  2007/03/01 22:01:14Z  timothyj
    Changed interface to take a block index in lieu of a linear byte offset.
    Revision 1.6  2006/12/20 21:34:27Z  timothyj
    ...
    Revision 1.5  2006/03/13 02:38:30Z  Garyp
    Updated the debug output to better describe "possible" bad blocks.
    Revision 1.4  2006/02/10 23:54:58Z  Garyp
    Header updates.
    Revision 1.3  2006/02/10 00:33:16Z  Garyp
    Updated to use device/disk handles rather than the EXTMEDIAINFO structure.
    Revision 1.2  2006/02/09 19:03:25Z  Pauli
    Updated comments.
    Revision 1.1  2005/12/08 17:26:18Z  Garyp
    Initial revision
---------------------------------------------------------------------------*/
#include <flashfx.h>
#include <fxdevapi.h>
