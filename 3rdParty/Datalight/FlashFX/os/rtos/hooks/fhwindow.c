...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: fhwindow.c $
    Revision 1.10  2009/07/18 01:33:12Z  garyp
    Merged from the v4.0 branch.  Headers updated.
    Revision 1.9  2009/04/08 15:09:52Z  davidh
    Function headers updated for AutoDoc.
    Revision 1.8  2008/03/19 21:00:45Z  Garyp
    Modified to use some slightly relocated DEVICE and DISK configuration info
    Revision 1.7  2008/01/13 07:29:25Z  keithg
