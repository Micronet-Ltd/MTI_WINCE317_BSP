...
/*---------------------------------------------------------------------------
    ...
    Revision 1.4  2008/01/13 07:28:45Z  keithg
    Function header updates to support autodoc.
    Revision 1.3  2007/11/03 23:50:03Z  Garyp
    Updated to use the standard module header.
    Revision 1.2  2006/05/06 00:14:12Z  Pauli
    Added "const" to input parameter.
    Revision 1.1  2006/01/25 17:31:46Z  Pauli
    Initial revision
---------------------------------------------------------------------------*/
...
static D_CHAR   gszCmdName[] = "FlashFXCheck";
    ...
    const char     *pszCmdLine)
{
    ...
    return FfxToolFramework(&tp, FfxCheckUnits);
}
