...
/*---------------------------------------------------------------------------
    ...
    Revision 1.4  2008/01/13 07:28:47Z  keithg
    Function header updates to support autodoc.
    Revision 1.3  2007/11/03 23:50:03Z  Garyp
    Updated to use the standard module header.
    Revision 1.2  2006/05/06 00:14:54Z  Pauli
    Added "const" to input parameter.
    Revision 1.1  2006/03/06 01:19:00Z  Garyp
    Initial revision
---------------------------------------------------------------------------*/
...
static char         szCmdName[] = "FlashFXImage";
    ...
    const char     *pszCmdLine)
{
    ...
    return FfxToolFramework(&tp, FfxImage);
}
