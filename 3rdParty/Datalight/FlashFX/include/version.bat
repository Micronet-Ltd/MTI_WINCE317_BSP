...
REM as the prefix for the variables set, otherwise "FX" will be used.
REM
...
set %T_PREFIX%_BUILDNUM=2128DF%NULLVAR%
...
REM NOTE: The FX_VERSION and FX_VERSIONVAL variables
REM       must match the values found in fxver.h.

REM $SIBLDVER=%                 The delimeters are "=" and "%"
set T_VERSION=v2.1.1%NULLVAR%
...
REM
set %T_PREFIX%_VERSIONVAL=0x02010100
