...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: ffxconf.h $
    Revision 1.13.1.2  2010/12/20 22:53:19Z  glenns
    Removed FFXCONF_SOFTLOCKSUPORT, as this feature is not
    supported in this product version.
    Revision 1.13  2010/11/20 23:50:05Z  glenns
    Added FFXCONF_QUICKMOUNTSUPPORT option.
    Revision 1.12  2010/03/02 18:44:28Z  glenns
    Fix Bug 2630: Apply PXA320_HACK more appropriately.
    Revision 1.11  2010/01/23 22:55:52Z  garyp
    Eliminated the FFX_DISK0_FORMAT setting.  Disk format settings
    for Windows CE are now handled entirely in the registry.
    Revision 1.10  2009/12/03 00:56:56Z  garyp
    Updated to no longer specify the PXA320 DFC physical register offset
    in this header.
    Revision 1.9  2009/07/19 02:48:02Z  garyp
    ...
    Revision 1.8  2009/04/03 05:12:24Z  keithg
    Work around for bug 2561: Removed FFXCONF_READAHEADENABLED
    Revision 1.7  2008/03/27 03:09:06Z  Garyp
    ...
    Disable FFXCONF_FORCEALIGNEDIO since that feature is not needed for this
    platform.
    Revision 1.6  2007/11/03 23:50:21Z  Garyp
    Updated to use the standard module header.
    Revision 1.5  2007/09/13 20:32:48Z  thomd
    default MTSTRESS param /time
    Revision 1.4  2007/09/13 16:19:56Z  thomd
    Updated FFX_MTTESTPARAMS
    Revision 1.3  2007/08/03 14:06:43Z  timothyj
    Changed device and disk settings from units of bytes to units of kilobytes.
    Revision 1.2  2007/07/31 02:44:15Z  Garyp
    Added missing timing and latency configuration settings.
    Revision 1.1  2007/06/01 19:20:56Z  rickc
    Initial revision
---------------------------------------------------------------------------*/
...
#define FFX_DEV0_NTMS           {&FFXNTM_pxa320, NULL}
#define FFX_DEV0_SETTINGS       {FFX_BADADDRESS, 0x0000C000, 0, FFX_REMAINING}
...
/*-------------------------------------------------------------------
    Aligned I/O is not required on this hardware, so disable this
    feature for better performance.
-------------------------------------------------------------------*/
#define FFXCONF_FORCEALIGNEDIO       FALSE

/*-------------------------------------------------------------------
    The following is unique for PXA320 projects. It sets a 
    macro that is used by the fmsl ECC test that tells the test
    to compensate for a particular bug in the PXA320 controller.
    See corresponding comment in common/tests/fmslecc.c.
-------------------------------------------------------------------*/
#define PXA320_HACK TRUE
