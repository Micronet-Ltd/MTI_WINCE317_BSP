...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: dclconf.h $
    Revision 1.7  2009/07/19 02:25:14Z  garyp
    Merged from the v4.0 branch.  Added the DCL_SERVICES setting.
    Revision 1.6  2007/12/14 23:15:37Z  Garyp
    Added Datalight Shell settings.
    Revision 1.5  2007/11/03 23:50:35Z  Garyp
    Updated to use the standard module header.
    Revision 1.4  2007/04/01 23:17:55Z  Garyp
    Added DCLCONF_MUTEXTRACKING.
    Revision 1.3  2007/03/06 03:31:29Z  Garyp
    Updated to use refactored and more flexible options for configuring debug
    output.
    Revision 1.2  2006/10/26 17:46:26Z  Garyp
    Added newly standardized output and timestamp settings.
    Revision 1.1  2005/12/08 20:18:00Z  timothyj
    Initial revision
---------------------------------------------------------------------------*/
