...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: fhoption.c $
    Revision 1.5  2009/07/17 19:41:16Z  garyp
    Merged from the v4.0 branch.  Eliminated use of an obsolete header.
    Revision 1.4  2009/03/23 21:08:58Z  keithg
    ...
    Revision 1.3  2008/03/23 04:25:48Z  Garyp
    Modified to use some slightly relocated DEVICE and DISK configuration info
    Revision 1.2  2007/11/03 23:50:35Z  Garyp
    Updated to use the standard module header.
    Revision 1.1  2006/03/09 23:46:50Z  timothyj
    Initial revision
    Revision 1.2  2006/02/10 02:48:10Z  Garyp
    Updated to use device/disk handles rather than the EXTMEDIAINFO structure.
    Revision 1.1  2005/10/06 05:51:02Z  Pauli
    Initial revision
    Revision 1.3  2004/12/30 23:38:18Z  GaryP
    Updated to use indents of 4, hard tabs of 8 (if used), and a standard
    comment style.
    Revision 1.2  2004/08/26 00:34:37Z  GaryP
    Moved the standard option handlers to option.c.
    Revision 1.1  2004/07/07 03:26:24Z  GaryP
    Initial revision
---------------------------------------------------------------------------*/
