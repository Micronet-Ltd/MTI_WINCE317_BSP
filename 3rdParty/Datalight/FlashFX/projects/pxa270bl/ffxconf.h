...
/*---------------------------------------------------------------------------
    ...
    Revision 1.5  2007/11/03 23:50:36Z  Garyp
    Updated to use the standard module header.
    Revision 1.4  2007/09/13 20:28:55Z  thomd
    default MTSTRESS param /time
    Revision 1.3  2007/09/13 16:20:04Z  thomd
    Updated FFX_MTTESTPARAMS
    Revision 1.2  2007/08/03 14:14:40Z  timothyj
    Changed device and disk settings from units of bytes to units of kilobytes.
    Revision 1.1  2007/05/24 19:22:06Z  rickc
    Initial revision
    Revision 1.10  2007/05/24 19:17:17Z  rickc
    Fixed base address, added 1MB of reserved space, increased
    disk size to 32MB
    Revision 1.9  2007/02/01 02:27:31Z  Garyp
    ...
    Revision 1.7  2006/04/04 01:01:08Z  michaelm
    ...
    Initial revision
    Revision 1.4  2004/12/30 17:31:34Z  GaryP
    Updated to use indents of 4, hard tabs of 8 (if used), and a standard
    comment style.
    Revision 1.3  2004/12/21 09:22:42Z  GaryP
    Removed an invalid setting.
    Revision 1.2  2004/11/30 21:26:50Z  tonyq
    Update to remove /f (format) parameter from vbftest options (no longer
    supported)
    Revision 1.1  2004/10/05 19:05:14Z  jaredw
    Initial revision
---------------------------------------------------------------------------*/
...
#define FFX_DEV0_SETTINGS       {(void*)0xbca00000L, 0x00000400, 0, 0x00007C00L}
...
/*-------------------------------------------------------------------
    ...
    FFX_DISKn_FORMAT
        ...
        The first field is reserved and should be zero.
        ...
        UseMBR is should always be TRUE for Windows CE.
...
#define FFX_DISK0_FORMAT        {0, FFX_FILESYS_RELIANCE, TRUE}
