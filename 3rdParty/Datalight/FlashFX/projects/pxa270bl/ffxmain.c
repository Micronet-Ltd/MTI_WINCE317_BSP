...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: ffxmain.c $
    Revision 1.3  2009/02/09 01:52:18Z  garyp
    ...
    Revision 1.1  2007/05/24 01:36:08Z  rickc
    Initial revision
---------------------------------------------------------------------------*/
...
{
    DclPrintf("FlashFX sample project for a Windows CE bootloader project on the Intel PXA27x\n");
