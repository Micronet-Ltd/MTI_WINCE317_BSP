...
/*---------------------------------------------------------------------------
    ...
    Revision 1.2  2006/10/03 23:32:57Z  Garyp
    Modified to use the new printf functions.
    Revision 1.1  2005/10/01 11:06:40Z  Pauli
    Initial revision
    Revision 1.2  2004/12/30 23:43:21Z  GaryP
    Updated to use indents of 4, hard tabs of 8 (if used), and a standard
    comment style.
    Revision 1.1  2004/10/05 19:04:14Z  jaredw
    Initial revision
---------------------------------------------------------------------------*/
...
{
    DclPrintf("FlashFX sample project for the Intel PXA27x platform running Windows CE.\n");
