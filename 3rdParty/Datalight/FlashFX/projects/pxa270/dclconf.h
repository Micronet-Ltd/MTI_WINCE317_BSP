...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: dclconf.h $
    Revision 1.8  2009/07/19 02:25:15Z  garyp
    Merged from the v4.0 branch.  Added the DCL_SERVICES setting.
    Revision 1.7  2007/11/03 23:50:36Z  Garyp
    Updated to use the standard module header.
    Revision 1.6  2007/07/31 02:47:33Z  Garyp
    Added settings for the Datalight Shell, and enabled the high-res timestamp.
    Revision 1.5  2007/04/01 23:17:16Z  Garyp
    Added DCLCONF_MUTEXTRACKING.
    Revision 1.4  2007/03/06 03:31:27Z  Garyp
    Updated to use refactored and more flexible options for configuring debug
    output.
    Revision 1.3  2006/10/26 17:43:55Z  Garyp
    Added newly standardized output and timestamp settings.
    Revision 1.2  2005/12/08 20:15:36Z  Garyp
    Added standardized DCL settings.
    Revision 1.1  2005/07/06 02:42:38Z  Pauli
    Initial revision
---------------------------------------------------------------------------*/
