...
/*---------------------------------------------------------------------------
    ...
    Revision 1.15  2009/04/03 05:12:31Z  keithg
    Work around for bug 2561: Removed FFXCONF_READAHEADENABLED
    Revision 1.14  2008/03/27 02:56:57Z  Garyp
    ...
    Revision 1.13  2007/11/03 23:50:36Z  Garyp
    Updated to use the standard module header.
    Revision 1.12  2007/09/13 20:28:55Z  thomd
    default MTSTRESS param /time
    Revision 1.11  2007/09/13 16:20:03Z  thomd
    Updated FFX_MTTESTPARAMS
    Revision 1.10  2007/08/03 14:13:51Z  timothyj
    Changed device and disk settings from units of bytes to units of kilobytes.
    Revision 1.9  2007/02/01 00:57:02Z  Garyp
    Added device timing and latency configuration settings.
    Revision 1.8  2006/10/13 01:47:33Z  Garyp
    ...
    Revision 1.7  2006/04/04 01:00:52Z  michaelm
    removed mention of fimlist.pdf and instead refer to website
    Revision 1.6  2006/03/08 20:53:08Z  Garyp
    Changed the NTM init process back to using a list of possible NTMs, rather
    than a single fixed NTM per Device.
    Revision 1.5  2006/03/04 21:39:37Z  Garyp
    Eliminated an unnecessary typecast.
    Revision 1.4  2006/02/13 10:35:05Z  Garyp
    Updated to the new configuration model.
    Revision 1.3  2005/12/30 16:48:55Z  Garyp
    Updated to use renamed thread related settings and functions, which are
    now a part of DCL.
    Revision 1.2  2005/12/08 04:46:44Z  Garyp
    Added a number of basic settings that are new with the merge.
    Revision 1.1  2005/10/22 06:32:38Z  Pauli
    Initial revision
    Revision 1.2  2005/10/22 07:32:37Z  garyp
    Added standardized TRACE, PROFILER, and READBACKVERIFY settings.
    Revision 1.1  2005/10/01 17:06:16Z  Garyp
    Initial revision
    Revision 1.2  2005/08/14 21:56:41Z  garyp
    Added the FFX_DCLTESTPARAMS setting.
    Revision 1.1  2004/12/30 19:31:34Z  pauli
    Initial revision
    Revision 1.16  2004/12/30 17:31:34Z  GaryP
    Updated to use indents of 4, hard tabs of 8 (if used), and a standard
    comment style.
    Revision 1.15  2004/12/21 09:22:42Z  GaryP
    Added some missing settings.
    Revision 1.14  2004/11/30 21:26:50Z  tonyq
    Update to remove /f (format) parameter from vbftest options (no longer
    supported)
    Revision 1.13  2004/09/29 06:49:55Z  GaryP
    More ffx/pro release changes.
    Revision 1.12  2004/09/29 01:48:18Z  GaryP
    General cleanup of configuration settings in preparation for FFX/Pro release.
    Revision 1.11  2004/09/23 02:44:58Z  GaryP
    Refactored for FFX/Pro release.
    Revision 1.10  2004/09/15 18:07:31Z  jaredw
    Now contians background garbage collection define.
    Revision 1.9  2004/01/24 23:25:14Z  garys
    Merge from FlashFXMT
    Revision 1.8.1.4  2004/01/24 23:25:14  garyp
    Eliminated the FFX_USEFATMONITOR setting.
    Revision 1.8.1.3  2003/12/29 06:55:30Z  garyp
    Changed to use the new MT Intel 2x16 FIM.
    Revision 1.8.1.2  2003/12/16 22:19:12Z  garyp
    Eliminated the use of MAX_MEG_FLASH_ARRAY.
    Revision 1.8  2003/06/05 17:55:06Z  garyp
    Renamed FFX_UNIT_TEST to FFXCONF_DRIVERAUTOTEST to match the other OESLs.
    Revision 1.7  2003/05/22 20:49:06Z  tonyq
    Updated for BOOTLDR project
    Revision 1.6  2003/04/21 00:59:30Z  garyp
    Removed the NVBF setting.
    Revision 1.5  2003/02/26 20:09:45Z  garyp
    Changed the project from Nucleus to Windows CE.
    Revision 1.4  2002/11/13 01:14:12Z  garyp
    Removed the __HAL_INTERFACE__ setting.
    Revision 1.3  2002/11/12 04:46:36Z  dennis
    Added copyright and usage restrictions header to several source files.
    Revision 1.2  2002/10/18 20:40:32  garyp
    Added the NVBF setting.
---------------------------------------------------------------------------*/
...
#define FFX_DEV0_FIMS           {&FFXFIM_isf2x16, NULL}
#define FFX_DEV0_NTMS           {NULL}
#define FFX_DEV0_SETTINGS       {(void*)0x00100000L, 0, 0, 0x00001000L}
