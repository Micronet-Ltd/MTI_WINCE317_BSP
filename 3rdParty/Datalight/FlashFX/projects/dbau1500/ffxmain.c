...
/*---------------------------------------------------------------------------
    ...
    Revision 1.2  2006/10/03 23:33:10Z  Garyp
    Modified to use the new printf functions.
    Revision 1.1  2005/10/01 11:03:52Z  Pauli
    Initial revision
    Revision 1.2  2004/12/30 17:33:39Z  GaryP
    Updated to use indents of 4, hard tabs of 8 (if used), and a standard
    comment style.
    Revision 1.1  2004/12/21 09:07:34Z  GaryP
    Initial revision
---------------------------------------------------------------------------*/
...
{
    DclPrintf("FlashFX sample project for the AMD Alchemy DBau1500 running Windows CE.\n");
