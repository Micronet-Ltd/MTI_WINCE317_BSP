...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: dclconf.h $
    Revision 1.9  2009/07/19 02:25:17Z  garyp
    Merged from the v4.0 branch.  Added the DCL_SERVICES setting.
    Revision 1.8  2007/11/03 23:50:37Z  Garyp
    Updated to use the standard module header.
    Revision 1.7  2007/05/21 18:27:29Z  Garyp
    Documentation fixes.
    Revision 1.6  2007/04/01 23:16:56Z  Garyp
    Added DCLCONF_MUTEXTRACKING.
    Revision 1.5  2007/03/06 03:31:26Z  Garyp
    Updated to use refactored and more flexible options for configuring debug
    output.
    Revision 1.4  2006/12/16 22:44:02Z  Garyp
    Modified to enable the HighRes timestamp functionality.
    Revision 1.3  2006/10/26 22:52:47Z  Garyp
    Added newly standardized output, shell, and timestamp settings.
    Revision 1.2  2006/03/10 20:13:02Z  Pauli
    Updated comments.
    Revision 1.1  2005/12/08 20:43:26Z  Pauli
    Initial revision
---------------------------------------------------------------------------*/
...
-------------------------------------------------------------------*/
#define DCLCONF_HIGHRESTIMESTAMP        TRUE
