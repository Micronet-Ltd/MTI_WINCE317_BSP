...
#				Revision History
#	$Log: dclproj.mak $
#	Revision 1.2  2009/11/09 04:22:52Z  garyp
#	Corrected a broken symbol name.
#	Revision 1.1  2008/12/17 23:47:14Z  garyp
#	Initial revision
#----------------------------------------------------------------------------
...
osdate.$(B_OBJEXT)   : $(PROJHEADERS) osdate.c
osdebug.$(B_OBJEXT)  : $(PROJHEADERS) osdebug.c
oshalt.$(B_OBJEXT)   : $(PROJHEADERS) oshalt.c
osmem.$(B_OBJEXT)    : $(PROJHEADERS) osmem.c
osmutex.$(B_OBJEXT)  : $(PROJHEADERS) osmutex.c
ossem.$(B_OBJEXT)    : $(PROJHEADERS) ossem.c
ossleep.$(B_OBJEXT)  : $(PROJHEADERS) ossleep.c
osthread.$(B_OBJEXT) : $(PROJHEADERS) osthread.c
ostick.$(B_OBJEXT)   : $(PROJHEADERS) ostick.c
