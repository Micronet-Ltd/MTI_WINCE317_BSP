...
/*---------------------------------------------------------------------------
    ...
    Revision 1.13  2007/11/03 23:50:37Z  Garyp
    Updated to use the standard module header.
    Revision 1.12  2007/10/30 23:07:03Z  pauli
    Disabled Reliance support by default so that this FFXP project can be
    used as is without requiring Reliance.
    Revision 1.11  2007/09/13 20:28:56Z  thomd
    default MTSTRESS param /time
    Revision 1.10  2007/09/13 16:20:04Z  thomd
    Updated FFX_MTTESTPARAMS
    Revision 1.9  2007/08/03 14:43:13Z  timothyj
    Changed device and disk settings from byte offsets to units of kilobytes.
    Revision 1.8  2007/02/01 00:54:06Z  Garyp
    Added device timing and latency configuration settings.
    Revision 1.7  2006/10/16 19:31:11Z  Garyp
    Updated to use some renamed symbols.
    Revision 1.6  2006/10/13 00:05:46Z  Garyp
...
#define FFX_DEV0_FIMS           {&FFXFIM_norfile, NULL}
#define FFX_DEV0_NTMS           {NULL}
#define FFX_DEV0_SETTINGS       {FFX_BADADDRESS, 0, 0, 0x00002000}
...
#define FFX_DEV1_FIMS           {&FFXFIM_norfile, NULL}
#define FFX_DEV1_NTMS           {NULL}
#define FFX_DEV1_SETTINGS       {FFX_BADADDRESS, 0, 0, 0x00003000}
