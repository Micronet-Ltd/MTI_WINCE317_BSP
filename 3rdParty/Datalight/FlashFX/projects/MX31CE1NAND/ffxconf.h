...
/*---------------------------------------------------------------------------
    ...
    Revision 1.11  2009/04/03 05:12:28Z  keithg
    Work around for bug 2561: Removed FFXCONF_READAHEADENABLED
    Revision 1.10  2008/03/27 02:56:49Z  Garyp
    ...
    Revision 1.9  2007/11/03 23:50:32Z  Garyp
    Updated to use the standard module header.
    Revision 1.8  2007/09/13 20:31:08Z  thomd
    default MTSTRESS param /time
    Revision 1.7  2007/09/13 16:20:01Z  thomd
    Updated FFX_MTTESTPARAMS
    Revision 1.6  2007/08/03 14:10:49Z  timothyj
    Changed device and disk settings from byte offsets to units of kilobytes.
    Revision 1.5  2007/02/01 01:11:16Z  Garyp
    Added device timing and latency configuration settings.
    Revision 1.4  2006/10/13 01:47:34Z  Garyp
    ...
    Revision 1.3  2006/08/07 15:36:01Z  timothyj
    Enabled DCLTEST and changed FFX_DEV0_SETTINGS to match the MX31BL1NAND
    project.
    Revision 1.2  2006/05/27 02:15:35Z  timothyj
    Removed OneNANDConf.h settings.
    Revision 1.1  2006/05/26 23:32:28Z  timothyj
    Initial revision
---------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------
    ...
    will support.  For OneBoot + File, only FFXCONF_NANDSUPPORT
    can be TRUE, all others must be false.
-------------------------------------------------------------------*/
...
#define FFX_DEV0_SETTINGS       {(D_BUFFER*)0xA0000000, 0x00001000UL, 0, 0x00001000UL}
