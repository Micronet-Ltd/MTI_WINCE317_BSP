...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: fhdevice.c $
    Revision 1.5  2009/07/17 20:47:59Z  garyp
    Merged from the v4.0 branch.  Eliminated use of an obsolete header.
    Revision 1.4  2008/03/23 04:11:16Z  Garyp
    ...
    Revision 1.2  2006/10/04 02:18:21Z  Garyp
    Updated to use DclMemAllocZero().
    Revision 1.1  2006/05/17 22:33:58Z  timothyj
    Initial revision
---------------------------------------------------------------------------*/
