...
#				Revision History
#	$Log: dclproj.mak $
#	Revision 1.1  2011/03/13 20:20:24Z  jimmb
#	Initial revision
#	Revision 1.3  2011/03/13 19:20:23Z  garyp
#	Added support for source replication.
#	Revision 1.2  2009/11/09 04:22:47Z  garyp
#	Fixed a broken symbol name.
...
#
PROJHEADERS  		= $(P_DCLROOT)/include/dlinstance.h
PROJINCLUDES 		=
...
# List the path and any source files which should be replicated from
# another location.  Do NOT specify a file extension -- .c files are
# the only file type supported.
#
DCLPROJREPLICATEPATH 	=
DCLPROJREPLICATESRC 	=
