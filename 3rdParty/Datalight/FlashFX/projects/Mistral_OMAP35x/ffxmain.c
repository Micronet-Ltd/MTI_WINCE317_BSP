...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: ffxmain.c $
    Revision 1.3  2009/04/14 20:40:11Z  thomd
    ...
    Revision 1.1  2008/10/09 19:15:42Z  garyp
    Initial revision
---------------------------------------------------------------------------*/
...
{
    DclPrintf("Datalight "D_PRODUCTNAME" sample project for the Mistral OMAP35x running Windows CE\n");
