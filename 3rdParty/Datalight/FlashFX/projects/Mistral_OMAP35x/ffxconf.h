...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: ffxconf.h $
    Revision 1.7.1.2  2010/12/20 22:45:32Z  glenns
    Removed FFXCONF_SOFTLOCKSUPORT, as this feature is not
    supported in this product version.
    Revision 1.7  2010/11/22 16:13:51Z  glenns
    Added FFXCONF_QUICKMOUNTSUPPORT option.
    Revision 1.6  2010/01/23 22:55:53Z  garyp
    Eliminated the FFX_DISK0_FORMAT setting.  Disk format settings
    for Windows CE are now handled entirely in the registry.
    Revision 1.5  2009/07/23 23:37:20Z  garyp
    Turned off FFXCONF_MIGRATE_LEGACY_FLASH since that functionality
    will mistakenly think the default MS format is bad block markers.
    Revision 1.4  2009/07/19 03:02:05Z  garyp
    ...
    Revision 1.3  2009/04/01 07:04:31Z  keithg
    Work around for bug 2561: Removed FFXCONF_READAHEADENABLED
    Revision 1.2  2009/02/09 16:46:04Z  garyp
    Checked in again to get around the MKS branch first conundrum.
    Revision 1.1  2008/10/17 23:59:36Z  garyp
    Initial revision
---------------------------------------------------------------------------*/
...
#define FFX_DEV0_SETTINGS       {(D_BUFFER*)0x0C000000, 0x400, 0, 0x00014C00}
...
/*  Not necessary when using the OneNAND NTM.
*/
