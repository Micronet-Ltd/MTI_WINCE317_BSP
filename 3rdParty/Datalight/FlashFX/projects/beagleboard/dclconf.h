...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: dclconf.h $
    Revision 1.5  2009/10/20 23:22:24Z  garyp
    Remapped the DclMemCpy/SetAligned() functions to use the C-library
    versions.
    Revision 1.4  2009/10/01 02:33:22Z  garyp
    Enabled the high-res timestamp.
    Revision 1.3  2009/09/24 19:40:39Z  garyp
    Documentation updated -- no functional changes.
    Revision 1.2  2009/09/23 23:12:04Z  garyp
    Added the DCL_SERVICES settings.
    Revision 1.1  2009/05/28 14:03:30Z  johnb
    Initial revision
---------------------------------------------------------------------------*/
...
/*  For this platform, the native memcpy/memset() functions are faster
    than our generic aligned functions, so use them instead.
*/    
