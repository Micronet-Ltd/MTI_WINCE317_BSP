...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: project.h $
    Revision 1.6  2011/04/16 21:11:11Z  garyp
    Documentation clarified -- no functional changes.
    Revision 1.5  2010/07/06 01:35:44Z  garyp
    Updated to work with multiple chip selects.  Added M60 support.
    Revision 1.4  2010/01/23 21:38:22Z  garyp
    Changed SUPPORT_DUAL_PLANE_OPS to default to TRUE.
    Revision 1.3  2009/12/13 00:07:01Z  garyp
    Updated to enable hardware ECC by default.  Added settings for
    controlling cache mode read/write and dual plane use.
    Revision 1.2  2009/10/06 23:40:27Z  garyp
    Default to using prefetch mode.
    Revision 1.1  2009/10/06 01:29:28Z  garyp
    Initial revision
---------------------------------------------------------------------------*/
