...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: ffxmain.c $
    Revision 1.4  2009/02/09 01:52:15Z  garyp
    Merged from the v4.0 branch.  Removed the heap initialization logic, as
    that is now done automatically based on settings in dclconf.h.
    Revision 1.3  2007/11/03 23:50:31Z  Garyp
    Updated to use the standard module header.
    Revision 1.2  2006/10/03 23:33:03Z  Garyp
    Documentation updated.
    Revision 1.1  2006/08/07 15:31:04Z  timothyj
    Initial revision
---------------------------------------------------------------------------*/
...
{
    DclPrintf("FlashFX sample project for a Windows CE bootloader on the FreeScale MX31\n");
