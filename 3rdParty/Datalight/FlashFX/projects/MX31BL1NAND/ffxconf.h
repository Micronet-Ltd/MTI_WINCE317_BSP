...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: ffxconf.h $
    Revision 1.10.1.2  2010/12/20 22:44:22Z  glenns
    Removed FFXCONF_SOFTLOCKSUPORT, as this feature is not
    supported in this product version.
    Revision 1.10  2010/11/22 16:13:52Z  glenns
    Added FFXCONF_QUICKMOUNTSUPPORT option.
    Revision 1.9  2009/07/18 23:18:55Z  garyp
    Merged from the v4.0 branch.  Added a Flags field to the Disk configuration
    settings.  Added a NAND Special Features section.  Removed some
    obsolete OneNAND configuration settings.
    Revision 1.8  2009/04/03 05:12:28Z  keithg
    Work around for bug 2561: Removed FFXCONF_READAHEADENABLED
    Revision 1.7  2008/03/27 02:56:49Z  Garyp
    ...
    Revision 1.6  2007/11/03 23:50:31Z  Garyp
    Updated to use the standard module header.
    Revision 1.5  2007/08/03 14:40:54Z  timothyj
    Changed device and disk settings from byte offsets to units of kilobytes.
    Revision 1.4  2007/02/01 01:12:40Z  Garyp
    Added device timing and latency configuration settings.
    Revision 1.3  2006/10/16 19:31:13Z  Garyp
    Updated to use some renamed symbols.
    Revision 1.2  2006/10/13 00:05:39Z  Garyp
    ...
    Revision 1.1  2006/08/07 15:36:16Z  timothyj
    Initial revision
---------------------------------------------------------------------------*/
...
#define FFX_DISK0_FORMAT        {FFX_FORMAT_ONCE, FFX_FILESYS_RELIANCE, TRUE}
