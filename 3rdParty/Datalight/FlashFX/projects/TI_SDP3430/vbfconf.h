...
/*---------------------------------------------------------------------------
                                Revision History
    $Log: vbfconf.h $
    Revision 1.1  2009/12/19 02:23:48Z  garyp
    Initial revision
---------------------------------------------------------------------------*/
...
-------------------------------------------------------------------*/
#define VBFCONF_REGIONCACHESIZE         (50)
...
-------------------------------------------------------------------*/
#define VBF_COMPACTION_BUFFER_SIZE      (32 * 1024UL)
...
/*-------------------------------------------------------------------
    ...
    default.
-------------------------------------------------------------------*/
#define VBF_MIN_BLOCK_SIZE              (FFX_MAX_PAGESIZE)
