...
---------------------------------------------------------------------------*/
/* COBF by BB -- 'bbm_migrate.c' obfuscated at Tue Apr 24 23:20:51 2012
*/
#include "cobf.h"
...
(FooFFXBbmBaro FooFFXBbmBarp,FooFFXBbmBarl91* FooFFXBbmBarl212);FFXSTATUS FooFFXBbmBarl2421(FooFFXBbmBarz  *FooFFXBbmBarg){(FooFFXBbmBard)(FooFFXBbmBarg);
FooFFXBbmBarl52 FooFFXBbmBarl284;}FFXSTATUS
FooFFXBbmBarl2489(FooFFXBbmBarz*FooFFXBbmBarg){( FooFFXBbmBard)(FooFFXBbmBarg);FooFFXBbmBarl52
FooFFXBbmBarl284;}FFXSTATUS FooFFXBbmBarl2301(FooFFXBbmBarz  *FooFFXBbmBarg){(FooFFXBbmBard)(FooFFXBbmBarg);
FooFFXBbmBarl52 FooFFXBbmBarl284;}
