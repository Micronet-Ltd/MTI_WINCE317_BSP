...
static S32 TiCon_Init_Console_Menu(TiCon_t* pTiCon)
{
    ...
    Console_AddToken(pTiCon->hConsole, h2, (PS8)"Disable", (PS8)"Enable Rx Data Filtering", (FuncToken_t) CuCmd_DisableRxDataFilters, NULL );
    {
        ...
        Console_AddToken(pTiCon->hConsole, h2, (PS8)"active Add", (PS8)"Add Rx Data Filter", (FuncToken_t) CuCmd_AddRxDataFilter, aaa );
    }
    {
        ConParm_t aaa[]  = 
        {
        ...
        Console_AddToken(pTiCon->hConsole, h2, (PS8)"active Remove", (PS8)"Remove Rx Data Filter", (FuncToken_t) CuCmd_RemoveRxDataFilter, aaa );
    }
    {
        ConParm_t aaa[]  = 
        {
        ...
        Console_AddToken(pTiCon->hConsole, h2, (PS8)"susPend-add", (PS8)"Add Rx Suspend Filter", (FuncToken_t) CuCmd_AddRxSuspendFilter, aaa );
    }
    {
        ConParm_t aaa[]  = 
        {
        ...
        Console_AddToken(pTiCon->hConsole, h2, (PS8)"suspend-remoVe", (PS8)"Remove Rx Suspend Filter", (FuncToken_t) CuCmd_RemoveRxSuspendFilter, aaa );
    }
    ...
    Console_AddToken(pTiCon->hConsole, h2, (PS8)"show-filTers", (PS8)"Display Rx Data Filters", (FuncToken_t) CuCmd_PrintRxDataFilters, NULL );
