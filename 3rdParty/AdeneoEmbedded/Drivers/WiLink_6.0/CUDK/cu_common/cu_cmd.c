...
{    
    ...
    { FILE_ID_10  ,  (PS8)"admCtrlCcx              " },
    { FILE_ID_11  ,  (PS8)"ccxMngr                 " },
    { FILE_ID_12  ,  (PS8)"ccxRMMngr               " },
    { FILE_ID_13  ,  (PS8)"ccxTSMngr               " },
    { FILE_ID_14  ,  (PS8)"rogueAp                 " },
    { FILE_ID_15  ,  (PS8)"TransmitPowerCcx        " },
...
#ifdef CCX_MODULE_INCLUDED
    if(OK != CuCommon_GetU32(pCuCmd->hCuCommon, RSN_CCX_NETWORK_EAP, &CcxNetEap)) return;
#endif
...
#ifdef CCX_MODULE_INCLUDED
    os_error_printf(CU_MSG_INFO2, (PS8)"Driver version: %s_CCX\r\n", 
                                                SW_VERSION_STR);
#elif GEM_SUPPORTED
