...
TI_STATUS cmdBld_ConfigFw (TI_HANDLE hCmdBld, void *fConfigFwCb, TI_HANDLE hConfigFwCb)
{
	...
	WLAN_OS_REPORT (("Firmware config\r\n"));
...
TI_STATUS __itr_memory_map (TI_HANDLE hCmdBld)
{
	...
	WLAN_OS_REPORT(("__itr_memory_map:Interrogate TX/RX parameters\r\n"));

    /* Interrogate TX/RX parameters */
    stat =  cmdBld_ItrIeMemoryMap (hCmdBld, 
                                  &pCmdBld->tMemMap, 
                                  (void *)cmdBld_ConfigFwCb, 
                                  hCmdBld);
	WLAN_OS_REPORT(("__itr_memory_map:Interrogate TX/RX parameters %d\r\n", stat));
	return stat;
}
