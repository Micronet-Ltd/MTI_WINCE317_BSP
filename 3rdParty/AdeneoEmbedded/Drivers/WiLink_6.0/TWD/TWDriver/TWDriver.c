...
static TI_STATUS TWD_ConfigFwCb (TI_HANDLE hTWD, TI_STATUS status)
{
	...
	//WLAN_OS_REPORT(("TWD_ConfigFwCb: Call callback\r\n"));
    if (pTWD->fConfigFwCb) 
    {
...
void TWD_FinalizeDownload (TI_HANDLE hTWD)
{
	...
	//WLAN_OS_REPORT(("TWD_FinalizeDownload: Call callback\r\n"));
...
//		WLAN_OS_REPORT(("TWD_StopComplete: call callback\r\n"));
...
TI_STATUS TWD_Stop (TI_HANDLE hTWD)
{
	...
	//WLAN_OS_REPORT(("TWD_Stop: twIf restarted %d\r\n", status));
