...
#define HCI_VS_SET_PCM_LOOPBACK_ENABLE		0xFE28
#define HCI_VS_WRITE_CODEC_CONFIG			0xFD06
#define HCI_VS_WRITE_CODEC_CONFIG_ENHANCED	0xFD07
#define HCI_VS_A3DP_CODEC_CONFIGURATION		0xFD8E
...
typedef struct {
	UINT16	PCM_clock_rate;
	UINT8	PCM_clock_direction;
	UINT32	Frame_sync_frequency;
	UINT16	Frame_sync_duty_cycle;
	UINT8	Frame_sync_edge;
	UINT8	Frame_sync_polarity;
	UINT8	Reserved;
	UINT16	Channel1_data_out_size;
	UINT16	Channel1_data_out_offset;
	UINT8	Channel1_data_out_edge;
	UINT16	Channel1_data_in_size;
	UINT16	Channel1_data_in_offset;
	UINT8	Channel1_data_in_edge;
	UINT8	Reserved2;
	UINT16	Channel2_data_out_size;
	UINT16	Channel2_data_out_offset;
	UINT8	Channel2_data_out_edge;
	UINT16	Channel2_data_in_size;
	UINT16	Channel2_data_in_offset;
	UINT8	Channel2_data_in_edge;
	UINT8	Reserved3;
} HCI_VS_CODEC_CONFIG;

typedef struct {
	UINT8	PCM_clock_shutdown;
	UINT16	PCM_clock_start;
	UINT16	PCM_clock_stop;
	UINT8	Reserved;
	UINT8	Channel1_data_in_order;
	UINT8	Channel1_data_out_order;
	UINT8	Channel1_data_out_mode;
	UINT8	Channel1_data_out_duplication;
	UINT32	Channel1_TX_dup_value;
	UINT8	Channel1_data_quant;
	UINT8	Reserved2;
	UINT8	Channel2_data_in_order;
	UINT8	Channel2_data_out_order;
	UINT8	Channel2_data_out_mode;
	UINT8	Channel2_data_out_duplication;
	UINT32	Channel2_TX_dup_value;
	UINT8	Channel2_data_quant;
	UINT8	Reserved3;	
} HCI_VS_CODEC_CONFIG_ENHANCED;

typedef struct {
	UINT8	Audio_Source;
	UINT8	PCM_input_sample_frequency;
	UINT8	PCM_number_of_channels;
	UINT8	SBC_input_sample_frequency;
	UINT8	SBC_channel_mode;
	UINT8	SBC_number_of_blocks;
	UINT8	SBC_number_of_sub_bands;
	UINT8	SBC_allocation_method;
	UINT8	SBC_bit_pool_low_boundary;
	UINT8	SBC_recommended_bit_pull;
	UINT8	SBC_dynamic_bit_pull_enable;
	UINT32	Reserved;
	UINT32	Reserved2;
} HCI_VS_A3DP_CODEC_CONFIG;

typedef struct {
	HCI_COMMAND_PACKET_HEADER header;
	union {
		UINT8							par0;
		HCI_VS_CODEC_CONFIG				codecConfig;
		HCI_VS_CODEC_CONFIG_ENHANCED	codecConfigEnhanced;
		HCI_VS_A3DP_CODEC_CONFIG		A3DP_CodecConfig;
	} params;
} HCI_COMMAND_PACKET_WITH_PARAMETERS;
...
typedef struct {
    ...
    union {
		...
		HCI_COMMAND_PACKET_WITH_PARAMETERS commandWithParams;
    };
} HCI_PACKET_HEADER;
...
//------------------------------------------------------------------------------
//
#define BT_GPIO_SHUTDOWN	GPIO_137
//#define IRQ_GPIO_144 272 // GPIO5 bit 16 (GPIO IRQs starts at 128)
#define BT_CTS_WAKEUP_IRQ   IRQ_GPIO_140
#define UART2_CTS			GPIO_140
#define UART2_RTS			GPIO_141
...
BOOL btSleep_to_Awake_transition;
