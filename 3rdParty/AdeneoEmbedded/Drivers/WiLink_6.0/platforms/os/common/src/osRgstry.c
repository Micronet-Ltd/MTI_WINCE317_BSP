...
NDIS_STRING STRSuspendAction         = NDIS_STRING_CONST("SuspendAction"); 
...
------------------------------------*/
    ...
    regReadIntegerParameter(pAdapter, &STRSuspendAction,
                            SUSPEND_ACTION_DEF, SUSPEND_ACTION_MIN, SUSPEND_ACTION_MAX,
                            sizeof (p->tDrvMainParams.eSuspendAction),
                            (TI_UINT8*)&(p->tDrvMainParams.eSuspendAction));
