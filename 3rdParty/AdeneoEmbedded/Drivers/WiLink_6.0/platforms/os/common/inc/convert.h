...
#define TIWLN_ADD_RX_SUSPEND_FILTER                     RX_DATA_ADD_RX_SUSPEND_FILTER
#define TIWLN_REMOVE_RX_SUSPEND_FILTER                  RX_DATA_REMOVE_RX_SUSPEND_FILTER
#define TIWLN_PRINT_RX_DATA_FILTERS                  	RX_DATA_PRINT_RX_DATA_FILTERS
