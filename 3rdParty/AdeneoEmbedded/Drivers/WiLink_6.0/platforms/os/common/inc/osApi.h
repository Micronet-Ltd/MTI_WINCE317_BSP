...
/** \brief  Gets the number of active wake locks
 * 
 * \param  OsContext - Handle to the OS object
 * \return wake_lock counter
 * 
 * \par Description
 *   Gets the number of active wake locks
 */
int os_WakeLockCount (TI_HANDLE OsContext);
...
TI_INT32 os_getMAC(TI_UINT16 *, TI_UINT32);
#ifdef __cplusplus
}
#endif
