...
*/
    ...
    RX_DATA_ADD_RX_SUSPEND_FILTER              	=   SET_BIT           | RX_DATA_MODULE_PARAM | 0x0A,						/**< RX Data Add Suspend Filter Parameter (RX Data Module Set Command): \n  
																															* Used for adding Suspend mode RX Data Filter to FW\n
																															* Done Sync with no memory allocation\n 
																															* Parameter Number:	0x05	\n
																															* Module Number: RX Data Module Number \n
																															* Async Bit: OFF	\n
																															...
																															* SET Bit: ON	\n
																															*/
    RX_DATA_REMOVE_RX_SUSPEND_FILTER           	=   SET_BIT           | RX_DATA_MODULE_PARAM | 0x0B,						/**< RX Data Remove Suspend Filter Parameter (RX Data Module Set Command): \n  
																															* Used for removing Suspend RX Data Filter from FW\n
																															* Done Sync with no memory allocation\n 
																															* Parameter Number:	0x06	\n
																															* Module Number: RX Data Module Number \n
																															* Async Bit: OFF	\n
																															...
																															* SET Bit: ON	\n
																															*/
    RX_DATA_PRINT_RX_DATA_FILTERS		     	=             GET_BIT | RX_DATA_MODULE_PARAM | 0x0C,						/**< RX Data Print RX Data Filters (RX Data Module Get Command): \n  
																															* Used for printing RX Data Filters\n
																															* Parameter Number:	0x0C	\n
																															* Module Number: RX Data Module Number \n
																															* Allocate Bit: OFF	\n
																															* GET Bit: ON	\n
